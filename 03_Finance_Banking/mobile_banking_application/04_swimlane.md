# Swimlane Diagram — Mobile Banking Application
...
flowchart LR
    ...
    subgraph SystemLane["Mobile Banking Application"]
...
| 3 | Mobile Banking Application | Performs automated parameter validation, computes business logic, coordinates balance postings, dispatches alert notifications, and records audit logs |
