# Context Diagram — Air Cargo Management System
...
flowchart LR
    ...
    System((" Air Cargo Management System "))
...
Hệ thống **Air Cargo Management System (Hệ thống Quản lý Vận tải Hàng không)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
