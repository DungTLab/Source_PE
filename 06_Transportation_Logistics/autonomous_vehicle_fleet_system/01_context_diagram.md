# Context Diagram — Autonomous Vehicle Fleet System
...
flowchart LR
    ...
    System((" Autonomous Vehicle Fleet System "))
...
Hệ thống **Autonomous Vehicle Fleet System (Hệ thống Đội xe Tự lái)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
