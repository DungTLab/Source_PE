# Context Diagram — Cargo Booking System
...
Hệ thống **Cargo Booking System (Hệ thống Đặt chỗ Hàng hóa)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
