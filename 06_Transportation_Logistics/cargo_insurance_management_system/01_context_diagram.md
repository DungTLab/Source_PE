# Context Diagram — Cargo Insurance Management System
...
flowchart LR
    ...
    System((" Cargo Insurance Management System "))
...
Hệ thống **Cargo Insurance Management System (Hệ thống Quản lý Bảo hiểm Hàng hóa)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
