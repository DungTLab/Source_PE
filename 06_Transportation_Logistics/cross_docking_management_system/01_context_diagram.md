# Context Diagram — Cross-Docking Management System
...
flowchart LR
    ...
    System((" Cross-Docking Management System "))
...
Hệ thống **Cross-Docking Management System (Hệ thống Quản lý Cross-Docking)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
