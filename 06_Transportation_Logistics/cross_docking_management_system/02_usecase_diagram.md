# Use Case Diagram — Cross-Docking Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Cross-Docking Management System"]
...
|---|-------|------------|------------------|-------------------|
| 1 | Warehouse Manager | Primary | Initiates operational requests, monitors real-time progress, manages bookings/orders | UC01, UC02, UC03, UC04 |
| 2 | Forklift / Picker Staff | Primary | Receives dispatch assignments, executes physical operations, reports progress and issues | UC05, UC06, UC07, UC08 |
| 3 | Inventory Controller | Primary | Oversees route planning, resource allocation, real-time tracking, and analytics | UC09, UC10, UC11, UC14 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Submit Operational Request | Warehouse Manager | System | Creates a new transport, dispatch, or operational order | High |
| 2 | UC02 | Track Execution Status | Warehouse Manager | Telematics Gateway | Provides real-time visibility and status tracking for active requests | High |
| 3 | UC03 | Cancel or Modify Request | Warehouse Manager | Dispatcher | Allows updating or cancelling pending requests prior to execution | Medium |
| 4 | UC04 | Authenticate User | System | Auth Gateway | Validates user identity, credentials, and role permissions | High |
| 5 | UC05 | Accept & Execute Task | Forklift / Picker Staff | System | Acknowledges assigned operational task and marks start of execution | High |
| 6 | UC06 | Update Task Progress | Forklift / Picker Staff | Telematics Gateway | Records status milestones, timestamps, and GPS checkpoints | High |
| 7 | UC07 | Log Incident or Delay | Forklift / Picker Staff | Dispatcher | Reports traffic congestion, vehicle breakdown, or cargo exceptions | Medium |
| 8 | UC08 | Complete Task Execution | Forklift / Picker Staff | Customer | Finalizes task, captures proof of delivery/execution, closes assignment | High |
| 9 | UC09 | Optimize Route & Schedule | Inventory Controller | Map API | Calculates optimal paths, schedules, and load distributions | High |
| 10 | UC10 | Dispatch Resource & Assignment | Inventory Controller | Field Agent | Assigns vehicles, drivers, or equipment to scheduled tasks | High |
| 11 | UC11 | Monitor Real-time Dashboard | Inventory Controller | Telematics Gateway | Displays live fleet/asset map, active jobs, and SLA alerts | High |
...
| 14 | UC14 | Generate Performance Reports | Inventory Controller | Audit System | Compiles operational efficiency, fuel, SLA compliance, and cost analytics | Medium |
...
| **Actor(s)** | Primary: Warehouse Manager <br> Secondary: System |
...
| **Actor(s)** | Primary: Forklift / Picker Staff |
...
| **Actor(s)** | Primary: Forklift / Picker Staff <br> Secondary: Telematics Gateway |
...
| **Actor(s)** | Primary: Forklift / Picker Staff <br> Secondary: Customer |
...
| **Actor(s)** | Primary: Inventory Controller <br> Secondary: Map API |
