# Context Diagram — Crowdsourced Delivery Platform
...
flowchart LR
    ...
    System((" Crowdsourced Delivery Platform "))
...
Hệ thống **Crowdsourced Delivery Platform (Nền tảng Giao hàng Cộng đồng)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
