# Context Diagram — Customs & Border Control System
...
flowchart LR
    ...
    System((" Customs & Border Control System "))
...
Hệ thống **Customs & Border Control System (Hệ thống Hải quan & Kiểm soát Biên giới)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
