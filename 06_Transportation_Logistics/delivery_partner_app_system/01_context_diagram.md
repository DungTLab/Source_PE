# Context Diagram — Delivery Partner App System
...
flowchart LR
    ...
    System((" Delivery Partner App System "))
...
Hệ thống **Delivery Partner App System (Hệ thống Ứng dụng Đối tác Giao hàng)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
