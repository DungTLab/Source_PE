# Context Diagram — Driver Management & Compliance System
...
flowchart LR
    ...
    System((" Driver Management & Compliance System "))
...
Hệ thống **Driver Management & Compliance System (Hệ thống Quản lý Tài xế & Tuân thủ)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
