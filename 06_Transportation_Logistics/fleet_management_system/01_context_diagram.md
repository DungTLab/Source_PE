# Context Diagram — Fleet Management System
...
Hệ thống **Fleet Management System (Hệ thống Quản lý Đội phương tiện)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
