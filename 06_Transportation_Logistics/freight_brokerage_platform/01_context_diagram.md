# Context Diagram — Freight Brokerage Platform
...
flowchart LR
    ...
    System((" Freight Brokerage Platform "))
...
Hệ thống **Freight Brokerage Platform (Nền tảng Môi giới Vận tải)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
