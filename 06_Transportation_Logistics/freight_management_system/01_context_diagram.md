# Context Diagram — Freight Management System
...
Hệ thống **Freight Management System (Hệ thống Quản lý Vận tải Hàng hóa)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
