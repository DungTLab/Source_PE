# Context Diagram — Fuel Management System
...
Hệ thống **Fuel Management System (Hệ thống Quản lý Nhiên liệu)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
