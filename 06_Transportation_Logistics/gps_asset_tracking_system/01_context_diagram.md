# Context Diagram — GPS Asset Tracking System
...
flowchart LR
    ...
    System((" GPS Asset Tracking System "))
...
Hệ thống **GPS Asset Tracking System (Hệ thống Theo dõi Tài sản GPS)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
