# Use Case Diagram — Hazardous Material Tracking System

## Mermaid Code

```mermaid
flowchart LR
    actor_P1["Safety & Compliance Officer"]
    actor_P2["Cold Chain Logistics Driver"]
    actor_P3["Quality Auditor"]
    actor_P4["System Administrator"]

    subgraph SystemBoundary["Hazardous Material Tracking System"]
...
|---|-------|------------|------------------|-------------------|
| 1 | Safety & Compliance Officer | Primary | Initiates operational requests, monitors real-time progress, manages bookings/orders | UC01, UC02, UC03, UC04 |
| 2 | Cold Chain Logistics Driver | Primary | Receives dispatch assignments, executes physical operations, reports progress and issues | UC05, UC06, UC07, UC08 |
| 3 | Quality Auditor | Primary | Oversees route planning, resource allocation, real-time tracking, and analytics | UC09, UC10, UC11, UC14 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Submit Operational Request | Safety & Compliance Officer | System | Creates a new transport, dispatch, or operational order | High |
| 2 | UC02 | Track Execution Status | Safety & Compliance Officer | Telematics Gateway | Provides real-time visibility and status tracking for active requests | High |
| 3 | UC03 | Cancel or Modify Request | Safety & Compliance Officer | Dispatcher | Allows updating or cancelling pending requests prior to execution | Medium |
| 4 | UC04 | Authenticate User | System | Auth Gateway | Validates user identity, credentials, and role permissions | High |
| 5 | UC05 | Accept & Execute Task | Cold Chain Logistics Driver | System | Acknowledges assigned operational task and marks start of execution | High |
| 6 | UC06 | Update Task Progress | Cold Chain Logistics Driver | Telematics Gateway | Records status milestones, timestamps, and GPS checkpoints | High |
| 7 | UC07 | Log Incident or Delay | Cold Chain Logistics Driver | Dispatcher | Reports traffic congestion, vehicle breakdown, or cargo exceptions | Medium |
| 8 | UC08 | Complete Task Execution | Cold Chain Logistics Driver | Customer | Finalizes task, captures proof of delivery/execution, closes assignment | High |
| 9 | UC09 | Optimize Route & Schedule | Quality Auditor | Map API | Calculates optimal paths, schedules, and load distributions | High |
| 10 | UC10 | Dispatch Resource & Assignment | Quality Auditor | Field Agent | Assigns vehicles, drivers, or equipment to scheduled tasks | High |
| 11 | UC11 | Monitor Real-time Dashboard | Quality Auditor | Telematics Gateway | Displays live fleet/asset map, active jobs, and SLA alerts | High |
...
| 14 | UC14 | Generate Performance Reports | Quality Auditor | Audit System | Compiles operational efficiency, fuel, SLA compliance, and cost analytics | Medium |
...
| **Actor(s)** | Primary: Safety & Compliance Officer <br> Secondary: System |
...
| **Actor(s)** | Primary: Cold Chain Logistics Driver |
...
| **Actor(s)** | Primary: Cold Chain Logistics Driver <br> Secondary: Telematics Gateway |
...
| **Actor(s)** | Primary: Cold Chain Logistics Driver <br> Secondary: Customer |
...
| **Actor(s)** | Primary: Quality Auditor <br> Secondary: Map API |
