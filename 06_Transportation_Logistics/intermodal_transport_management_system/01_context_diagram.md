# Context Diagram — Intermodal Transport Management System
...
flowchart LR
    ...
    System((" Intermodal Transport Management System "))
...
Hệ thống **Intermodal Transport Management System (Hệ thống Quản lý Vận tải Đa phương thức)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
