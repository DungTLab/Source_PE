# Context Diagram — International Freight Forwarding System
...
flowchart LR
    ...
    System((" International Freight Forwarding System "))
...
Hệ thống **International Freight Forwarding System (Hệ thống Giao nhận Vận tải Quốc tế)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
