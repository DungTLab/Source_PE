# Context Diagram — Last-Mile Delivery Management System
...
flowchart LR
    ...
    System((" Last-Mile Delivery Management System "))
...
Hệ thống **Last-Mile Delivery Management System (Hệ thống Quản lý Giao hàng Chặng cuối)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
