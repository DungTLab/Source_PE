# Context Diagram — Last-Mile Locker System
...
flowchart LR
    ...
    System((" Last-Mile Locker System "))
...
Hệ thống **Last-Mile Locker System (Hệ thống Tủ khóa Giao hàng Chặng cuối)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
