# Context Diagram — Logistics Analytics Platform
...
flowchart LR
    ...
    System((" Logistics Analytics Platform "))
...
Hệ thống **Logistics Analytics Platform (Nền tảng Phân tích Logistics)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
