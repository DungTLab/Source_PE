# Context Diagram — Logistics Partner Integration System
...
flowchart LR
    ...
    System((" Logistics Partner Integration System "))
...
Hệ thống **Logistics Partner Integration System (Hệ thống Tích hợp Đối tác Logistics)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
