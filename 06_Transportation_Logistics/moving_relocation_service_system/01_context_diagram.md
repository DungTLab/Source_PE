# Context Diagram — Moving & Relocation Service System
...
flowchart LR
    ...
    System((" Moving & Relocation Service System "))
...
Hệ thống **Moving & Relocation Service System (Hệ thống Dịch vụ Chuyển nhà)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
