# Context Diagram — Parcel Tracking System
...
Hệ thống **Parcel Tracking System (Hệ thống Theo dõi Bưu kiện)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
