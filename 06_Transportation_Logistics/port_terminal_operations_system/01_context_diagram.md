# Context Diagram — Port & Terminal Operations System
...
flowchart LR
    ...
    System((" Port & Terminal Operations System "))
...
Hệ thống **Port & Terminal Operations System (Hệ thống Vận hành Cảng & Bến)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
