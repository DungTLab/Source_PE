# Context Diagram — Postal & Mail Management System
...
flowchart LR
    ...
    System((" Postal & Mail Management System "))
...
Hệ thống **Postal & Mail Management System (Hệ thống Quản lý Bưu chính)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
