# Context Diagram — Returns & Exchange Logistics System
...
flowchart LR
    ...
    System((" Returns & Exchange Logistics System "))
...
Hệ thống **Returns & Exchange Logistics System (Hệ thống Logistics Đổi trả Hàng)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
