# Context Diagram — Reverse Logistics Management System
...
flowchart LR
    ...
    System((" Reverse Logistics Management System "))
...
Hệ thống **Reverse Logistics Management System (Hệ thống Quản lý Logistics Ngược)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
