# Swimlane Diagram — Ride-Pooling & Carpooling Platform
...
flowchart LR
    ...
    subgraph Lane2["Ride-Pooling & Carpooling Platform (Core Engine)"]
...
| 2 | Ride-Pooling & Carpooling Platform (Core Engine) | Đóng vai trò hệ thống trung tâm: kiểm tra tính hợp lệ, chạy thuật toán tối ưu hóa lộ trình, phân công tài nguyên, giám sát GPS và xác thực ePOD. |
