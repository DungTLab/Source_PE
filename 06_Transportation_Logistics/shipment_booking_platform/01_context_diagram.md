# Context Diagram — Shipment Booking Platform
...
flowchart LR
    ...
    System((" Shipment Booking Platform "))
...
Hệ thống **Shipment Booking Platform (Nền tảng Đặt chỗ Vận chuyển)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
