# Context Diagram — Shipyard Management System
...
flowchart LR
    ...
    System((" Shipyard Management System "))
...
Hệ thống **Shipyard Management System (Hệ thống Quản lý Xưởng Đóng tàu)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
