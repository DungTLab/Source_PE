# Context Diagram — Supply Chain Management System
...
Hệ thống **Supply Chain Management System (Hệ thống Quản lý Chuỗi cung ứng)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
