# Context Diagram — Taxi Dispatch System
...
Hệ thống **Taxi Dispatch System (Hệ thống Điều phối Taxi)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
