# Context Diagram — Transport Booking Aggregator
...
flowchart LR
    ...
    System((" Transport Booking Aggregator "))
...
Hệ thống **Transport Booking Aggregator (Nền tảng Tổng hợp Đặt vé Vận tải)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
