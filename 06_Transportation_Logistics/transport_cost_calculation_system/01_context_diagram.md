# Context Diagram — Transport Cost Calculation System
...
flowchart LR
    ...
    System((" Transport Cost Calculation System "))
...
Hệ thống **Transport Cost Calculation System (Hệ thống Tính phí Vận chuyển)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
