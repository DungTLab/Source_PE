# Context Diagram — Truck Load Optimization System
...
flowchart LR
    ...
    System((" Truck Load Optimization System "))
...
Hệ thống **Truck Load Optimization System (Hệ thống Tối ưu Tải trọng Xe tải)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
