# Context Diagram — Vehicle Inspection Management System
...
flowchart LR
    ...
    System((" Vehicle Inspection Management System "))
...
Hệ thống **Vehicle Inspection Management System (Hệ thống Quản lý Kiểm định Phương tiện)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
