# Context Diagram — Vehicle Leasing Management System
...
flowchart LR
    ...
    System((" Vehicle Leasing Management System "))
...
Hệ thống **Vehicle Leasing Management System (Hệ thống Quản lý Cho thuê Phương tiện)** đóng vai trò là nền tảng điều hành trung tâm cho các hoạt động nghiệp vụ trong lĩnh vực vận tải & logistics.
