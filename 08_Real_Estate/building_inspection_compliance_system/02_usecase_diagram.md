# Use Case Diagram — Building Inspection & Compliance System
...
flowchart LR
    ...
    subgraph SystemBoundary["Building Inspection & Compliance System"]
        UC01(["Submit Building Inspection & Compliance Request"])
        UC02(["View Building Inspection & Compliance Dashboard"])
        UC03(["Manage Profile & Settings"])
        UC04(["Process Building Inspection & Compliance Application"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Resident / Occupant | Primary | Main user initiating building inspection & compliance system operations. | UC01, UC02, UC03, UC11, UC12 |
| 2 | Facility Manager | Primary | Handles operational workflows in building inspection & compliance system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Submit Building Inspection & Compliance Request | Resident / Occupant | Notification & SMS Gateway | Initiate a new request or operation within Building Inspection & Compliance System. | High |
| 2 | UC02 | View Building Inspection & Compliance Dashboard | Resident / Occupant | None | Display overview summary metrics, pending actions, and status updates. | High |
...
| 4 | UC04 | Process Building Inspection & Compliance Application | Facility Manager | Document Storage & e-Sign API | Evaluate submitted data, verify documents, and perform operational tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Submit Building Inspection & Compliance Request |
| **Actor(s)** | Primary: Resident / Occupant / Secondary: Notification & SMS Gateway |
| **Description** | Allows Resident / Occupant to submit a formal request or transaction within Building Inspection & Compliance System with validated inputs. |
| **Precondition** | 1. User is authenticated and logged into the system.<br>2. System services are active and accessible. |
| **Main Flow** | 1. User accesses the request submission page.<br>2. System presents input form tailored for Building Inspection & Compliance System.<br>3. User enters required details, uploads supporting files.<br>4. System validates inputs against business rules and data schemas.<br>5. User reviews summary and confirms submission.<br>6. System stores record with status 'PENDING_REVIEW'.<br>7. System triggers Notification & SMS Gateway to send confirmation notice to User. |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Building Inspection & Compliance Application |
