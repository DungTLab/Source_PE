...
flowchart LR
    ...
    subgraph Lane2["Construction Project Management System Processing Engine"]
...
| 2 | Construction Project Management System Processing Engine | Validates inputs, executes core logic, checks compliance, updates state. |
