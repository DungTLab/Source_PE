# Use Case Diagram — Property Valuation System
...
flowchart LR
    ...
    subgraph SystemBoundary["Property Valuation System"]
        UC01(["Submit Property Valuation Request"])
        UC02(["View Property Valuation Dashboard"])
        UC03(["Manage Profile & Settings"])
        UC04(["Process Property Valuation Application"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Applicant / Property Owner | Primary | Main user initiating property valuation system operations. | UC01, UC02, UC03, UC11, UC12 |
| 2 | Valation Specialist / Officer | Primary | Handles operational workflows in property valuation system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Submit Property Valuation Request | Applicant / Property Owner | Notification & SMS Gateway | Initiate a new request or operation within Property Valuation System. | High |
| 2 | UC02 | View Property Valuation Dashboard | Applicant / Property Owner | None | Display overview summary metrics, pending actions, and status updates. | High |
...
| 4 | UC04 | Process Property Valuation Application | Valation Specialist / Officer | Document Storage & e-Sign API | Evaluate submitted data, verify documents, and perform operational tasks. | High |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Property Valuation Application |
