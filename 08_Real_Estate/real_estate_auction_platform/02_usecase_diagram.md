# Use Case Diagram — Real Estate Auction Platform
...
flowchart LR
    ...
    subgraph SystemBoundary["Real Estate Auction Platform"]
        UC01(["Submit Real Estate Auction Request"])
        UC02(["View Real Estate Auction Dashboard"])
        UC03(["Manage Profile & Settings"])
        UC04(["Process Real Estate Auction Application"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Platform User / Client | Primary | Main user initiating real estate auction platform operations. | UC01, UC02, UC03, UC11, UC12 |
| 2 | Service Provider / Agent | Primary | Handles operational workflows in real estate auction platform. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Submit Real Estate Auction Request | Platform User / Client | Notification & SMS Gateway | Initiate a new request or operation within Real Estate Auction Platform. | High |
| 2 | UC02 | View Real Estate Auction Dashboard | Platform User / Client | None | Display overview summary metrics, pending actions, and status updates. | High |
...
| 4 | UC04 | Process Real Estate Auction Application | Service Provider / Agent | Document Storage & e-Sign API | Evaluate submitted data, verify documents, and perform operational tasks. | High |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Real Estate Auction Application |
