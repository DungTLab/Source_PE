# Swimlane Diagram — Short-Term Rental Platform
...
flowchart LR
    ...
    subgraph Lane2["Short-Term Rental Platform Processing Engine"]
...
| 2 | Short-Term Rental Platform Processing Engine | Validates inputs, executes core logic, checks compliance, updates state. |
