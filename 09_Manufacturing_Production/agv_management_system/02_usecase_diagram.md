# Use Case Diagram — Automated Guided Vehicle (AGV) Management System

## Mermaid Code

```mermaid
flowchart LR
    actor_1["Automation Engineer"]
    actor_2["IoT Systems Operator"]
    actor_3["Plant Operations Director"]
    actor_4["Safety Manager"]
    ...
    subgraph SystemBoundary["Automated Guided Vehicle (AGV) Management System"]
        UC01(["Execute Automated Guided Vehicle (AGV) Management Line Operation"])
        UC02(["View Automated Guided Vehicle (AGV) Management Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Automated Guided Vehicle (AGV) Management Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Automation Engineer | Primary | Main user initiating automated guided vehicle (agv) management system operations. | UC01, UC02, UC03, UC11 |
| 2 | IoT Systems Operator | Primary | Manages line execution in automated guided vehicle (agv) management system. | UC04, UC05, UC06, UC13 |
| 3 | Plant Operations Director | Primary | Manages factory line parameters and executive reporting. | UC07, UC08, UC10, UC12, UC14 |
| 4 | Safety Manager | Primary | Monitors regulatory adherence and quality standards. | UC09 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Automated Guided Vehicle (AGV) Management Line Operation | Automation Engineer | PLC & SCADA Controller System | Initiate line operations and data capture in Automated Guided Vehicle (AGV) Management System. | High |
| 2 | UC02 | View Automated Guided Vehicle (AGV) Management Shop Floor Dashboard | Automation Engineer | None | Display real-time line metrics, machine statuses, and production output. | High |
| 3 | UC03 | Configure Line Parameters & Recipe | Automation Engineer | PLC & SCADA Controller System | Set machine speed, temperature, pressure setpoints, and job parameters. | Medium |
| 4 | UC04 | Process Automated Guided Vehicle (AGV) Management Quality Inspection | IoT Systems Operator | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
| 5 | UC05 | Log Line Downtime & Fault Incident | IoT Systems Operator | PLC & SCADA Controller System | Record machine breakdown reasons, duration, and corrective actions. | High |
| 6 | UC06 | Generate Line Yield & OEE Report | IoT Systems Operator | Enterprise ERP System API | Compile Overall Equipment Effectiveness (OEE), scrap rates, and output logs. | Medium |
| 7 | UC07 | Approve Production Batch & Order | Plant Operations Director | Industrial Safety & Standards Regulatory Portal | Review batch records and authorize final release to warehouse/shipping. | High |
| 8 | UC08 | Set Plant KPI & Safety Thresholds | Plant Operations Director | None | Define tolerance limits, SPC control boundaries, and alert escalation rules. | High |
| 9 | UC09 | Audit Line Traceability & Compliance | Safety Manager | Industrial Safety & Standards Regulatory Portal | Perform forward/backward batch traceability and compliance checks. | Medium |
| 10 | UC10 | Manage Shift Rosters & Workstation Roles | Plant Operations Director | None | Assign operators to workstation lines and grant machine clearance. | High |
| 11 | UC11 | Stream Real-time PLC Telemetry Data | PLC & SCADA Controller System | Automation Engineer | Continuous ingestion of temperature, vibration, and cycle data from equipment. | High |
| 12 | UC12 | Sync Orders with Enterprise ERP | Enterprise ERP System API | Plant Operations Director | Synchronize raw material issues, finished goods counts, and BOM changes. | Medium |
| 13 | UC13 | Capture Barcode & RFID Lot Tag | Industrial Barcode & RFID Gateway | IoT Systems Operator | Scan component serial numbers and associate them with production lot. | High |
| 14 | UC14 | Validate Regulatory Safety Standards | Industrial Safety & Standards Regulatory Portal | Plant Operations Director | Submit environmental, worker safety, and ISO compliance metrics. | Medium |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Automated Guided Vehicle (AGV) Management Line Operation |
| **Actor(s)** | Primary: Automation Engineer / Secondary: PLC & SCADA Controller System |
| **Description** | Allows Automation Engineer to start, monitor, and execute line operations for a scheduled work order. |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Automated Guided Vehicle (AGV) Management Quality Inspection |
| **Actor(s)** | Primary: IoT Systems Operator / Secondary: Industrial Barcode & RFID Gateway |
| **Description** | Allows IoT Systems Operator to record quality inspection results, measurements, and defect classifications for produced units. |
...
| **Actor(s)** | Primary: Plant Operations Director / Secondary: Industrial Safety & Standards Regulatory Portal |
| **Description** | Enables Plant Operations Director to review full batch genealogy, quality records, and authorize final product release. |
...
| **Actor(s)** | Primary: PLC & SCADA Controller System / Secondary: Automation Engineer |
