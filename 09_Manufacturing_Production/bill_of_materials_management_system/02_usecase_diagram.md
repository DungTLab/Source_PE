# Use Case Diagram — Bill of Materials (BOM) Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Bill of Materials (BOM) Management System"]
        UC01(["Execute Bill of Materials (BOM) Management Line Operation"])
        UC02(["View Bill of Materials (BOM) Management Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Bill of Materials (BOM) Management Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Production Manager | Primary | Main user initiating bill of materials (bom) management system operations. | UC01, UC02, UC03, UC11 |
| 2 | Shop Floor Supervisor | Primary | Manages line execution in bill of materials (bom) management system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Bill of Materials (BOM) Management Line Operation | Production Manager | PLC & SCADA Controller System | Initiate line operations and data capture in Bill of Materials (BOM) Management System. | High |
| 2 | UC02 | View Bill of Materials (BOM) Management Shop Floor Dashboard | Production Manager | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Bill of Materials (BOM) Management Quality Inspection | Shop Floor Supervisor | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Bill of Materials (BOM) Management Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Bill of Materials (BOM) Management Quality Inspection |
