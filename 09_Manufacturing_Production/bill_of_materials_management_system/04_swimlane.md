# Swimlane Diagram — Bill of Materials (BOM) Management System
...
flowchart LR
    ...
    subgraph Lane2["Bill of Materials (BOM) Management System Control Core"]
...
| 2 | Bill of Materials (BOM) Management System Control Core | Validates inputs, controls machinery interfaces, computes OEE, records state. |
