# Use Case Diagram — Carbon Footprint Tracking System
...
flowchart LR
    ...
    subgraph SystemBoundary["Carbon Footprint Tracking System"]
        UC01(["Execute Carbon Footprint Tracking Line Operation"])
        UC02(["View Carbon Footprint Tracking Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Carbon Footprint Tracking Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | EHS Specialist | Primary | Main user initiating carbon footprint tracking system operations. | UC01, UC02, UC03, UC11 |
| 2 | Safety Officer | Primary | Manages line execution in carbon footprint tracking system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Carbon Footprint Tracking Line Operation | EHS Specialist | PLC & SCADA Controller System | Initiate line operations and data capture in Carbon Footprint Tracking System. | High |
| 2 | UC02 | View Carbon Footprint Tracking Shop Floor Dashboard | EHS Specialist | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Carbon Footprint Tracking Quality Inspection | Safety Officer | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Carbon Footprint Tracking Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Carbon Footprint Tracking Quality Inspection |
