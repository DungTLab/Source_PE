# Use Case Diagram — Chemical Manufacturing Safety System
...
flowchart LR
    ...
    subgraph SystemBoundary["Chemical Manufacturing Safety System"]
        UC01(["Execute Chemical Manufacturing Safety Line Operation"])
        UC02(["View Chemical Manufacturing Safety Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Chemical Manufacturing Safety Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | EHS Specialist | Primary | Main user initiating chemical manufacturing safety system operations. | UC01, UC02, UC03, UC11 |
| 2 | Safety Officer | Primary | Manages line execution in chemical manufacturing safety system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Chemical Manufacturing Safety Line Operation | EHS Specialist | PLC & SCADA Controller System | Initiate line operations and data capture in Chemical Manufacturing Safety System. | High |
| 2 | UC02 | View Chemical Manufacturing Safety Shop Floor Dashboard | EHS Specialist | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Chemical Manufacturing Safety Quality Inspection | Safety Officer | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Chemical Manufacturing Safety Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Chemical Manufacturing Safety Quality Inspection |
