# Use Case Diagram — Continuous Manufacturing System
...
flowchart LR
    ...
    subgraph SystemBoundary["Continuous Manufacturing System"]
        UC01(["Execute Continuous Manufacturing Line Operation"])
        UC02(["View Continuous Manufacturing Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Continuous Manufacturing Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Production Manager | Primary | Main user initiating continuous manufacturing system operations. | UC01, UC02, UC03, UC11 |
| 2 | Shop Floor Supervisor | Primary | Manages line execution in continuous manufacturing system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Continuous Manufacturing Line Operation | Production Manager | PLC & SCADA Controller System | Initiate line operations and data capture in Continuous Manufacturing System. | High |
| 2 | UC02 | View Continuous Manufacturing Shop Floor Dashboard | Production Manager | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Continuous Manufacturing Quality Inspection | Shop Floor Supervisor | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Continuous Manufacturing Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Continuous Manufacturing Quality Inspection |
