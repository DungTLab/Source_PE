# Swimlane Diagram — Continuous Manufacturing System
...
flowchart LR
    ...
    subgraph Lane2["Continuous Manufacturing System Control Core"]
...
| 2 | Continuous Manufacturing System Control Core | Validates inputs, controls machinery interfaces, computes OEE, records state. |
