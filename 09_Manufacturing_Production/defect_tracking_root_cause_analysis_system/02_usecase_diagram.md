# Use Case Diagram — Defect Tracking & Root Cause Analysis System
...
flowchart LR
    ...
    subgraph SystemBoundary["Defect Tracking & Root Cause Analysis System"]
        UC01(["Execute Defect Tracking & Root Cause Analysis Line Operation"])
        UC02(["View Defect Tracking & Root Cause Analysis Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Defect Tracking & Root Cause Analysis Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Quality Assurance Engineer | Primary | Main user initiating defect tracking & root cause analysis system operations. | UC01, UC02, UC03, UC11 |
| 2 | Quality Inspector | Primary | Manages line execution in defect tracking & root cause analysis system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Defect Tracking & Root Cause Analysis Line Operation | Quality Assurance Engineer | PLC & SCADA Controller System | Initiate line operations and data capture in Defect Tracking & Root Cause Analysis System. | High |
| 2 | UC02 | View Defect Tracking & Root Cause Analysis Shop Floor Dashboard | Quality Assurance Engineer | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Defect Tracking & Root Cause Analysis Quality Inspection | Quality Inspector | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Defect Tracking & Root Cause Analysis Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Defect Tracking & Root Cause Analysis Quality Inspection |
