# Use Case Diagram — Digital Twin Manufacturing System
...
flowchart LR
    ...
    subgraph SystemBoundary["Digital Twin Manufacturing System"]
        UC01(["Execute Digital Twin Manufacturing Line Operation"])
        UC02(["View Digital Twin Manufacturing Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Digital Twin Manufacturing Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Automation Engineer | Primary | Main user initiating digital twin manufacturing system operations. | UC01, UC02, UC03, UC11 |
| 2 | IoT Systems Operator | Primary | Manages line execution in digital twin manufacturing system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Digital Twin Manufacturing Line Operation | Automation Engineer | PLC & SCADA Controller System | Initiate line operations and data capture in Digital Twin Manufacturing System. | High |
| 2 | UC02 | View Digital Twin Manufacturing Shop Floor Dashboard | Automation Engineer | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Digital Twin Manufacturing Quality Inspection | IoT Systems Operator | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Digital Twin Manufacturing Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Digital Twin Manufacturing Quality Inspection |
