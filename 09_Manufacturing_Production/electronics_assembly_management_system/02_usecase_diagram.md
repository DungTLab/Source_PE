# Use Case Diagram — Electronics Assembly Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Electronics Assembly Management System"]
        UC01(["Execute Electronics Assembly Management Line Operation"])
        UC02(["View Electronics Assembly Management Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Electronics Assembly Management Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Production Manager | Primary | Main user initiating electronics assembly management system operations. | UC01, UC02, UC03, UC11 |
| 2 | Shop Floor Supervisor | Primary | Manages line execution in electronics assembly management system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Electronics Assembly Management Line Operation | Production Manager | PLC & SCADA Controller System | Initiate line operations and data capture in Electronics Assembly Management System. | High |
| 2 | UC02 | View Electronics Assembly Management Shop Floor Dashboard | Production Manager | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Electronics Assembly Management Quality Inspection | Shop Floor Supervisor | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Electronics Assembly Management Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Electronics Assembly Management Quality Inspection |
