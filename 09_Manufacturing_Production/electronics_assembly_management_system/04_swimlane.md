# Swimlane Diagram — Electronics Assembly Management System
...
flowchart LR
    ...
    subgraph Lane2["Electronics Assembly Management System Control Core"]
...
| 2 | Electronics Assembly Management System Control Core | Validates inputs, controls machinery interfaces, computes OEE, records state. |
