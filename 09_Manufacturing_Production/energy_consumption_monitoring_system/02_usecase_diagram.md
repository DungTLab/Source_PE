# Use Case Diagram — Energy Consumption Monitoring System
...
flowchart LR
    ...
    subgraph SystemBoundary["Energy Consumption Monitoring System"]
        UC01(["Execute Energy Consumption Monitoring Line Operation"])
        UC02(["View Energy Consumption Monitoring Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Energy Consumption Monitoring Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Automation Engineer | Primary | Main user initiating energy consumption monitoring system operations. | UC01, UC02, UC03, UC11 |
| 2 | IoT Systems Operator | Primary | Manages line execution in energy consumption monitoring system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Energy Consumption Monitoring Line Operation | Automation Engineer | PLC & SCADA Controller System | Initiate line operations and data capture in Energy Consumption Monitoring System. | High |
| 2 | UC02 | View Energy Consumption Monitoring Shop Floor Dashboard | Automation Engineer | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Energy Consumption Monitoring Quality Inspection | IoT Systems Operator | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Energy Consumption Monitoring Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Energy Consumption Monitoring Quality Inspection |
