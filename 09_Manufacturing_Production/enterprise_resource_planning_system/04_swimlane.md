# Swimlane Diagram — Enterprise Resource Planning (ERP) System
...
flowchart LR
    ...
    subgraph Lane2["Enterprise Resource Planning (ERP) System Control Core"]
...
| 2 | Enterprise Resource Planning (ERP) System Control Core | Validates inputs, controls machinery interfaces, computes OEE, records state. |
