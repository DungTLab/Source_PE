# Use Case Diagram — Environmental Compliance Monitoring System

## Mermaid Code

```mermaid
flowchart LR
    actor_1["EHS Specialist"]
    actor_2["Safety Officer"]
    actor_3["Plant Compliance Director"]
    actor_4["Government Auditor"]
    ...
    subgraph SystemBoundary["Environmental Compliance Monitoring System"]
        UC01(["Execute Environmental Compliance Monitoring Line Operation"])
        UC02(["View Environmental Compliance Monitoring Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Environmental Compliance Monitoring Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | EHS Specialist | Primary | Main user initiating environmental compliance monitoring system operations. | UC01, UC02, UC03, UC11 |
| 2 | Safety Officer | Primary | Manages line execution in environmental compliance monitoring system. | UC04, UC05, UC06, UC13 |
| 3 | Plant Compliance Director | Primary | Manages factory line parameters and executive reporting. | UC07, UC08, UC10, UC12, UC14 |
| 4 | Government Auditor | Primary | Monitors regulatory adherence and quality standards. | UC09 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Environmental Compliance Monitoring Line Operation | EHS Specialist | PLC & SCADA Controller System | Initiate line operations and data capture in Environmental Compliance Monitoring System. | High |
| 2 | UC02 | View Environmental Compliance Monitoring Shop Floor Dashboard | EHS Specialist | None | Display real-time line metrics, machine statuses, and production output. | High |
| 3 | UC03 | Configure Line Parameters & Recipe | EHS Specialist | PLC & SCADA Controller System | Set machine speed, temperature, pressure setpoints, and job parameters. | Medium |
| 4 | UC04 | Process Environmental Compliance Monitoring Quality Inspection | Safety Officer | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
| 5 | UC05 | Log Line Downtime & Fault Incident | Safety Officer | PLC & SCADA Controller System | Record machine breakdown reasons, duration, and corrective actions. | High |
| 6 | UC06 | Generate Line Yield & OEE Report | Safety Officer | Enterprise ERP System API | Compile Overall Equipment Effectiveness (OEE), scrap rates, and output logs. | Medium |
| 7 | UC07 | Approve Production Batch & Order | Plant Compliance Director | Industrial Safety & Standards Regulatory Portal | Review batch records and authorize final release to warehouse/shipping. | High |
| 8 | UC08 | Set Plant KPI & Safety Thresholds | Plant Compliance Director | None | Define tolerance limits, SPC control boundaries, and alert escalation rules. | High |
| 9 | UC09 | Audit Line Traceability & Compliance | Government Auditor | Industrial Safety & Standards Regulatory Portal | Perform forward/backward batch traceability and compliance checks. | Medium |
| 10 | UC10 | Manage Shift Rosters & Workstation Roles | Plant Compliance Director | None | Assign operators to workstation lines and grant machine clearance. | High |
| 11 | UC11 | Stream Real-time PLC Telemetry Data | PLC & SCADA Controller System | EHS Specialist | Continuous ingestion of temperature, vibration, and cycle data from equipment. | High |
| 12 | UC12 | Sync Orders with Enterprise ERP | Enterprise ERP System API | Plant Compliance Director | Synchronize raw material issues, finished goods counts, and BOM changes. | Medium |
| 13 | UC13 | Capture Barcode & RFID Lot Tag | Industrial Barcode & RFID Gateway | Safety Officer | Scan component serial numbers and associate them with production lot. | High |
| 14 | UC14 | Validate Regulatory Safety Standards | Industrial Safety & Standards Regulatory Portal | Plant Compliance Director | Submit environmental, worker safety, and ISO compliance metrics. | Medium |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Environmental Compliance Monitoring Line Operation |
| **Actor(s)** | Primary: EHS Specialist / Secondary: PLC & SCADA Controller System |
| **Description** | Allows EHS Specialist to start, monitor, and execute line operations for a scheduled work order. |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Environmental Compliance Monitoring Quality Inspection |
| **Actor(s)** | Primary: Safety Officer / Secondary: Industrial Barcode & RFID Gateway |
| **Description** | Allows Safety Officer to record quality inspection results, measurements, and defect classifications for produced units. |
...
| **Actor(s)** | Primary: Plant Compliance Director / Secondary: Industrial Safety & Standards Regulatory Portal |
| **Description** | Enables Plant Compliance Director to review full batch genealogy, quality records, and authorize final product release. |
...
| **Actor(s)** | Primary: PLC & SCADA Controller System / Secondary: EHS Specialist |
