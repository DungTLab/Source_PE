# Use Case Diagram — Factory Automation Control System
...
flowchart LR
    ...
    subgraph SystemBoundary["Factory Automation Control System"]
        UC01(["Execute Factory Automation Control Line Operation"])
        UC02(["View Factory Automation Control Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Factory Automation Control Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Automation Engineer | Primary | Main user initiating factory automation control system operations. | UC01, UC02, UC03, UC11 |
| 2 | IoT Systems Operator | Primary | Manages line execution in factory automation control system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Factory Automation Control Line Operation | Automation Engineer | PLC & SCADA Controller System | Initiate line operations and data capture in Factory Automation Control System. | High |
| 2 | UC02 | View Factory Automation Control Shop Floor Dashboard | Automation Engineer | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Factory Automation Control Quality Inspection | IoT Systems Operator | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Factory Automation Control Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Factory Automation Control Quality Inspection |
