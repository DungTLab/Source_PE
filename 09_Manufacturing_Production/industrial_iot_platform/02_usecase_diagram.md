# Use Case Diagram — Industrial IoT Platform
...
flowchart LR
    ...
    subgraph SystemBoundary["Industrial IoT Platform"]
        UC01(["Execute Industrial IoT Line Operation"])
        UC02(["View Industrial IoT Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Industrial IoT Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Automation Engineer | Primary | Main user initiating industrial iot platform operations. | UC01, UC02, UC03, UC11 |
| 2 | IoT Systems Operator | Primary | Manages line execution in industrial iot platform. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Industrial IoT Line Operation | Automation Engineer | PLC & SCADA Controller System | Initiate line operations and data capture in Industrial IoT Platform. | High |
| 2 | UC02 | View Industrial IoT Shop Floor Dashboard | Automation Engineer | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Industrial IoT Quality Inspection | IoT Systems Operator | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Industrial IoT Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Industrial IoT Quality Inspection |
