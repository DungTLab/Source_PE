# Use Case Diagram — ISO & Regulatory Compliance System
...
flowchart LR
    ...
    subgraph SystemBoundary["ISO & Regulatory Compliance System"]
        UC01(["Execute ISO & Regulatory Compliance Line Operation"])
        UC02(["View ISO & Regulatory Compliance Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process ISO & Regulatory Compliance Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | EHS Specialist | Primary | Main user initiating iso & regulatory compliance system operations. | UC01, UC02, UC03, UC11 |
| 2 | Safety Officer | Primary | Manages line execution in iso & regulatory compliance system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute ISO & Regulatory Compliance Line Operation | EHS Specialist | PLC & SCADA Controller System | Initiate line operations and data capture in ISO & Regulatory Compliance System. | High |
| 2 | UC02 | View ISO & Regulatory Compliance Shop Floor Dashboard | EHS Specialist | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process ISO & Regulatory Compliance Quality Inspection | Safety Officer | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute ISO & Regulatory Compliance Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process ISO & Regulatory Compliance Quality Inspection |
