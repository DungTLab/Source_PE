# Use Case Diagram — Labor Efficiency Tracking System
...
flowchart LR
    ...
    subgraph SystemBoundary["Labor Efficiency Tracking System"]
        UC01(["Execute Labor Efficiency Tracking Line Operation"])
        UC02(["View Labor Efficiency Tracking Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Labor Efficiency Tracking Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Production Manager | Primary | Main user initiating labor efficiency tracking system operations. | UC01, UC02, UC03, UC11 |
| 2 | Shop Floor Supervisor | Primary | Manages line execution in labor efficiency tracking system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Labor Efficiency Tracking Line Operation | Production Manager | PLC & SCADA Controller System | Initiate line operations and data capture in Labor Efficiency Tracking System. | High |
| 2 | UC02 | View Labor Efficiency Tracking Shop Floor Dashboard | Production Manager | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Labor Efficiency Tracking Quality Inspection | Shop Floor Supervisor | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Labor Efficiency Tracking Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Labor Efficiency Tracking Quality Inspection |
