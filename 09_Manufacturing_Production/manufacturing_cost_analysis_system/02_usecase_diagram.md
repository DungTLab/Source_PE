# Use Case Diagram — Manufacturing Cost Analysis System
...
flowchart LR
    ...
    subgraph SystemBoundary["Manufacturing Cost Analysis System"]
        UC01(["Execute Manufacturing Cost Analysis Line Operation"])
        UC02(["View Manufacturing Cost Analysis Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Manufacturing Cost Analysis Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Production Manager | Primary | Main user initiating manufacturing cost analysis system operations. | UC01, UC02, UC03, UC11 |
| 2 | Shop Floor Supervisor | Primary | Manages line execution in manufacturing cost analysis system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Manufacturing Cost Analysis Line Operation | Production Manager | PLC & SCADA Controller System | Initiate line operations and data capture in Manufacturing Cost Analysis System. | High |
| 2 | UC02 | View Manufacturing Cost Analysis Shop Floor Dashboard | Production Manager | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Manufacturing Cost Analysis Quality Inspection | Shop Floor Supervisor | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Manufacturing Cost Analysis Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Manufacturing Cost Analysis Quality Inspection |
