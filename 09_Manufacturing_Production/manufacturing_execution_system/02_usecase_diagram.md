# Use Case Diagram — Manufacturing Execution System (MES)
...
flowchart LR
    ...
    subgraph SystemBoundary["Manufacturing Execution System (MES)"]
        UC01(["Execute Manufacturing Execution (MES) Line Operation"])
        UC02(["View Manufacturing Execution (MES) Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Manufacturing Execution (MES) Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Production Manager | Primary | Main user initiating manufacturing execution system (mes) operations. | UC01, UC02, UC03, UC11 |
| 2 | Shop Floor Supervisor | Primary | Manages line execution in manufacturing execution system (mes). | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Manufacturing Execution (MES) Line Operation | Production Manager | PLC & SCADA Controller System | Initiate line operations and data capture in Manufacturing Execution System (MES). | High |
| 2 | UC02 | View Manufacturing Execution (MES) Shop Floor Dashboard | Production Manager | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Manufacturing Execution (MES) Quality Inspection | Shop Floor Supervisor | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Manufacturing Execution (MES) Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Manufacturing Execution (MES) Quality Inspection |
