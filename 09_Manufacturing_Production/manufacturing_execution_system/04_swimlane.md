# Swimlane Diagram — Manufacturing Execution System (MES)
...
flowchart LR
    ...
    subgraph Lane2["Manufacturing Execution System (MES) Control Core"]
...
| 2 | Manufacturing Execution System (MES) Control Core | Validates inputs, controls machinery interfaces, computes OEE, records state. |
