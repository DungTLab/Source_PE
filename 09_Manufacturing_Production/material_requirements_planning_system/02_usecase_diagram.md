# Use Case Diagram — Material Requirements Planning (MRP) System
...
flowchart LR
    ...
    subgraph SystemBoundary["Material Requirements Planning (MRP) System"]
        UC01(["Execute Material Requirements Planning (MRP) Line Operation"])
        UC02(["View Material Requirements Planning (MRP) Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Material Requirements Planning (MRP) Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Production Manager | Primary | Main user initiating material requirements planning (mrp) system operations. | UC01, UC02, UC03, UC11 |
| 2 | Shop Floor Supervisor | Primary | Manages line execution in material requirements planning (mrp) system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Material Requirements Planning (MRP) Line Operation | Production Manager | PLC & SCADA Controller System | Initiate line operations and data capture in Material Requirements Planning (MRP) System. | High |
| 2 | UC02 | View Material Requirements Planning (MRP) Shop Floor Dashboard | Production Manager | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Material Requirements Planning (MRP) Quality Inspection | Shop Floor Supervisor | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Material Requirements Planning (MRP) Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Material Requirements Planning (MRP) Quality Inspection |
