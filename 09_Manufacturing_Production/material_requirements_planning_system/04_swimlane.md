# Swimlane Diagram — Material Requirements Planning (MRP) System
...
flowchart LR
    ...
    subgraph Lane2["Material Requirements Planning (MRP) System Control Core"]
...
| 2 | Material Requirements Planning (MRP) System Control Core | Validates inputs, controls machinery interfaces, computes OEE, records state. |
