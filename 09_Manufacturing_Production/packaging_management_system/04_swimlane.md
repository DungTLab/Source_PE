# Swimlane Diagram — Packaging Management System
...
flowchart LR
    ...
    subgraph Lane2["Packaging Management System Control Core"]
...
| 2 | Packaging Management System Control Core | Validates inputs, controls machinery interfaces, computes OEE, records state. |
