# Use Case Diagram — Predictive Maintenance System (ML)
...
flowchart LR
    ...
    subgraph SystemBoundary["Predictive Maintenance System (ML)"]
        UC01(["Execute Predictive Maintenance (ML) Line Operation"])
        UC02(["View Predictive Maintenance (ML) Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Predictive Maintenance (ML) Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Maintenance Technician | Primary | Main user initiating predictive maintenance system (ml) operations. | UC01, UC02, UC03, UC11 |
| 2 | Reliability Engineer | Primary | Manages line execution in predictive maintenance system (ml). | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Predictive Maintenance (ML) Line Operation | Maintenance Technician | PLC & SCADA Controller System | Initiate line operations and data capture in Predictive Maintenance System (ML). | High |
| 2 | UC02 | View Predictive Maintenance (ML) Shop Floor Dashboard | Maintenance Technician | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Predictive Maintenance (ML) Quality Inspection | Reliability Engineer | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Predictive Maintenance (ML) Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Predictive Maintenance (ML) Quality Inspection |
