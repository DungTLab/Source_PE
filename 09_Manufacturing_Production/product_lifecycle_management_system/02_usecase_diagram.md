# Use Case Diagram — Product Lifecycle Management (PLM) System
...
flowchart LR
    ...
    subgraph SystemBoundary["Product Lifecycle Management (PLM) System"]
        UC01(["Execute Product Lifecycle Management (PLM) Line Operation"])
        UC02(["View Product Lifecycle Management (PLM) Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Product Lifecycle Management (PLM) Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Production Manager | Primary | Main user initiating product lifecycle management (plm) system operations. | UC01, UC02, UC03, UC11 |
| 2 | Shop Floor Supervisor | Primary | Manages line execution in product lifecycle management (plm) system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Product Lifecycle Management (PLM) Line Operation | Production Manager | PLC & SCADA Controller System | Initiate line operations and data capture in Product Lifecycle Management (PLM) System. | High |
| 2 | UC02 | View Product Lifecycle Management (PLM) Shop Floor Dashboard | Production Manager | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Product Lifecycle Management (PLM) Quality Inspection | Shop Floor Supervisor | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Product Lifecycle Management (PLM) Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Product Lifecycle Management (PLM) Quality Inspection |
