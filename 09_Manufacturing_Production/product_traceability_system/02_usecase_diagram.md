# Use Case Diagram — Product Traceability System
...
flowchart LR
    ...
    subgraph SystemBoundary["Product Traceability System"]
        UC01(["Execute Product Traceability Line Operation"])
        UC02(["View Product Traceability Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Product Traceability Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Production Manager | Primary | Main user initiating product traceability system operations. | UC01, UC02, UC03, UC11 |
| 2 | Shop Floor Supervisor | Primary | Manages line execution in product traceability system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Product Traceability Line Operation | Production Manager | PLC & SCADA Controller System | Initiate line operations and data capture in Product Traceability System. | High |
| 2 | UC02 | View Product Traceability Shop Floor Dashboard | Production Manager | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Product Traceability Quality Inspection | Shop Floor Supervisor | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Product Traceability Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Product Traceability Quality Inspection |
