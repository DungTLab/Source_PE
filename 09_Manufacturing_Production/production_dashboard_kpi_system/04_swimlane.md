# Swimlane Diagram — Production Dashboard & KPI System
...
flowchart LR
    ...
    subgraph Lane2["Production Dashboard & KPI System Control Core"]
...
| 2 | Production Dashboard & KPI System Control Core | Validates inputs, controls machinery interfaces, computes OEE, records state. |
