# Swimlane Diagram — Production Order Management System
...
flowchart LR
    ...
    subgraph Lane2["Production Order Management System Control Core"]
...
| 2 | Production Order Management System Control Core | Validates inputs, controls machinery interfaces, computes OEE, records state. |
