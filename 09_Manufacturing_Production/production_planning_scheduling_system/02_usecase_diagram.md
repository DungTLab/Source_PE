# Use Case Diagram — Production Planning & Scheduling System
...
flowchart LR
    ...
    subgraph SystemBoundary["Production Planning & Scheduling System"]
        UC01(["Execute Production Planning & Scheduling Line Operation"])
        UC02(["View Production Planning & Scheduling Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Production Planning & Scheduling Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Production Manager | Primary | Main user initiating production planning & scheduling system operations. | UC01, UC02, UC03, UC11 |
| 2 | Shop Floor Supervisor | Primary | Manages line execution in production planning & scheduling system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Production Planning & Scheduling Line Operation | Production Manager | PLC & SCADA Controller System | Initiate line operations and data capture in Production Planning & Scheduling System. | High |
| 2 | UC02 | View Production Planning & Scheduling Shop Floor Dashboard | Production Manager | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Production Planning & Scheduling Quality Inspection | Shop Floor Supervisor | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Production Planning & Scheduling Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Production Planning & Scheduling Quality Inspection |
