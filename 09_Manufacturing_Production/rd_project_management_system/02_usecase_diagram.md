# Use Case Diagram — R&D Project Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["R&D Project Management System"]
        UC01(["Execute R&D Project Management Line Operation"])
        UC02(["View R&D Project Management Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process R&D Project Management Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Production Manager | Primary | Main user initiating r&d project management system operations. | UC01, UC02, UC03, UC11 |
| 2 | Shop Floor Supervisor | Primary | Manages line execution in r&d project management system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute R&D Project Management Line Operation | Production Manager | PLC & SCADA Controller System | Initiate line operations and data capture in R&D Project Management System. | High |
| 2 | UC02 | View R&D Project Management Shop Floor Dashboard | Production Manager | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process R&D Project Management Quality Inspection | Shop Floor Supervisor | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute R&D Project Management Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process R&D Project Management Quality Inspection |
