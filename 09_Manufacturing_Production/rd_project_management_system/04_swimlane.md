# Swimlane Diagram — R&D Project Management System
...
flowchart LR
    ...
    subgraph Lane2["R&D Project Management System Control Core"]
...
| 2 | R&D Project Management System Control Core | Validates inputs, controls machinery interfaces, computes OEE, records state. |
