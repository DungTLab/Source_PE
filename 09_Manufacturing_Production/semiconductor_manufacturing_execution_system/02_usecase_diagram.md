# Use Case Diagram — Semiconductor Manufacturing Execution System
...
flowchart LR
    ...
    subgraph SystemBoundary["Semiconductor Manufacturing Execution System"]
        UC01(["Execute Semiconductor Manufacturing Execution Line Operation"])
        UC02(["View Semiconductor Manufacturing Execution Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Semiconductor Manufacturing Execution Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Production Manager | Primary | Main user initiating semiconductor manufacturing execution system operations. | UC01, UC02, UC03, UC11 |
| 2 | Shop Floor Supervisor | Primary | Manages line execution in semiconductor manufacturing execution system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Semiconductor Manufacturing Execution Line Operation | Production Manager | PLC & SCADA Controller System | Initiate line operations and data capture in Semiconductor Manufacturing Execution System. | High |
| 2 | UC02 | View Semiconductor Manufacturing Execution Shop Floor Dashboard | Production Manager | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Semiconductor Manufacturing Execution Quality Inspection | Shop Floor Supervisor | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Semiconductor Manufacturing Execution Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Semiconductor Manufacturing Execution Quality Inspection |
