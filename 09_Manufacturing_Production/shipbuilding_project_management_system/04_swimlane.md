# Swimlane Diagram — Shipbuilding Project Management System
...
flowchart LR
    ...
    subgraph Lane2["Shipbuilding Project Management System Control Core"]
...
| 2 | Shipbuilding Project Management System Control Core | Validates inputs, controls machinery interfaces, computes OEE, records state. |
