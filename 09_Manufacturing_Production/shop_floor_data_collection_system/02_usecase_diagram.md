# Use Case Diagram — Shop Floor Data Collection System
...
flowchart LR
    ...
    subgraph SystemBoundary["Shop Floor Data Collection System"]
        UC01(["Execute Shop Floor Data Collection Line Operation"])
        UC02(["View Shop Floor Data Collection Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Shop Floor Data Collection Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Production Manager | Primary | Main user initiating shop floor data collection system operations. | UC01, UC02, UC03, UC11 |
| 2 | Shop Floor Supervisor | Primary | Manages line execution in shop floor data collection system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Shop Floor Data Collection Line Operation | Production Manager | PLC & SCADA Controller System | Initiate line operations and data capture in Shop Floor Data Collection System. | High |
| 2 | UC02 | View Shop Floor Data Collection Shop Floor Dashboard | Production Manager | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Shop Floor Data Collection Quality Inspection | Shop Floor Supervisor | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Shop Floor Data Collection Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Shop Floor Data Collection Quality Inspection |
