# Use Case Diagram — Spare Parts & MRO Inventory System
...
flowchart LR
    ...
    subgraph SystemBoundary["Spare Parts & MRO Inventory System"]
        UC01(["Execute Spare Parts & MRO Inventory Line Operation"])
        UC02(["View Spare Parts & MRO Inventory Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Spare Parts & MRO Inventory Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Maintenance Technician | Primary | Main user initiating spare parts & mro inventory system operations. | UC01, UC02, UC03, UC11 |
| 2 | Reliability Engineer | Primary | Manages line execution in spare parts & mro inventory system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Spare Parts & MRO Inventory Line Operation | Maintenance Technician | PLC & SCADA Controller System | Initiate line operations and data capture in Spare Parts & MRO Inventory System. | High |
| 2 | UC02 | View Spare Parts & MRO Inventory Shop Floor Dashboard | Maintenance Technician | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Spare Parts & MRO Inventory Quality Inspection | Reliability Engineer | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Spare Parts & MRO Inventory Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Spare Parts & MRO Inventory Quality Inspection |
