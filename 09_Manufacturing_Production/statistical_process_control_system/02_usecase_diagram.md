# Use Case Diagram — Statistical Process Control (SPC) System
...
flowchart LR
    ...
    subgraph SystemBoundary["Statistical Process Control (SPC) System"]
        UC01(["Execute Statistical Process Control (SPC) Line Operation"])
        UC02(["View Statistical Process Control (SPC) Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Statistical Process Control (SPC) Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Quality Assurance Engineer | Primary | Main user initiating statistical process control (spc) system operations. | UC01, UC02, UC03, UC11 |
| 2 | Quality Inspector | Primary | Manages line execution in statistical process control (spc) system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Statistical Process Control (SPC) Line Operation | Quality Assurance Engineer | PLC & SCADA Controller System | Initiate line operations and data capture in Statistical Process Control (SPC) System. | High |
| 2 | UC02 | View Statistical Process Control (SPC) Shop Floor Dashboard | Quality Assurance Engineer | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Statistical Process Control (SPC) Quality Inspection | Quality Inspector | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Statistical Process Control (SPC) Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Statistical Process Control (SPC) Quality Inspection |
