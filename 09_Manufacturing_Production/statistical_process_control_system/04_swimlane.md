# Swimlane Diagram — Statistical Process Control (SPC) System
...
flowchart LR
    ...
    subgraph Lane2["Statistical Process Control (SPC) System Control Core"]
...
| 2 | Statistical Process Control (SPC) System Control Core | Validates inputs, controls machinery interfaces, computes OEE, records state. |
