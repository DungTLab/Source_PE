# Use Case Diagram — Supplier Quality Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Supplier Quality Management System"]
        UC01(["Execute Supplier Quality Management Line Operation"])
        UC02(["View Supplier Quality Management Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Supplier Quality Management Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Quality Assurance Engineer | Primary | Main user initiating supplier quality management system operations. | UC01, UC02, UC03, UC11 |
| 2 | Quality Inspector | Primary | Manages line execution in supplier quality management system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Supplier Quality Management Line Operation | Quality Assurance Engineer | PLC & SCADA Controller System | Initiate line operations and data capture in Supplier Quality Management System. | High |
| 2 | UC02 | View Supplier Quality Management Shop Floor Dashboard | Quality Assurance Engineer | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Supplier Quality Management Quality Inspection | Quality Inspector | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Supplier Quality Management Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Supplier Quality Management Quality Inspection |
