# Swimlane Diagram — Supplier Quality Management System
...
flowchart LR
    ...
    subgraph Lane2["Supplier Quality Management System Control Core"]
...
| 2 | Supplier Quality Management System Control Core | Validates inputs, controls machinery interfaces, computes OEE, records state. |
