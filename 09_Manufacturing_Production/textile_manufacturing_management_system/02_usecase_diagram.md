# Use Case Diagram — Textile Manufacturing Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Textile Manufacturing Management System"]
        UC01(["Execute Textile Manufacturing Management Line Operation"])
        UC02(["View Textile Manufacturing Management Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Textile Manufacturing Management Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Production Manager | Primary | Main user initiating textile manufacturing management system operations. | UC01, UC02, UC03, UC11 |
| 2 | Shop Floor Supervisor | Primary | Manages line execution in textile manufacturing management system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Textile Manufacturing Management Line Operation | Production Manager | PLC & SCADA Controller System | Initiate line operations and data capture in Textile Manufacturing Management System. | High |
| 2 | UC02 | View Textile Manufacturing Management Shop Floor Dashboard | Production Manager | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Textile Manufacturing Management Quality Inspection | Shop Floor Supervisor | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Textile Manufacturing Management Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Textile Manufacturing Management Quality Inspection |
