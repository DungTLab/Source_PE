# Use Case Diagram — Tooling & Die Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Tooling & Die Management System"]
        UC01(["Execute Tooling & Die Management Line Operation"])
        UC02(["View Tooling & Die Management Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Tooling & Die Management Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Maintenance Technician | Primary | Main user initiating tooling & die management system operations. | UC01, UC02, UC03, UC11 |
| 2 | Reliability Engineer | Primary | Manages line execution in tooling & die management system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Tooling & Die Management Line Operation | Maintenance Technician | PLC & SCADA Controller System | Initiate line operations and data capture in Tooling & Die Management System. | High |
| 2 | UC02 | View Tooling & Die Management Shop Floor Dashboard | Maintenance Technician | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Tooling & Die Management Quality Inspection | Reliability Engineer | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Tooling & Die Management Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Tooling & Die Management Quality Inspection |
