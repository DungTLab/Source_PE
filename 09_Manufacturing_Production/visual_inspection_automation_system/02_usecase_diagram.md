# Use Case Diagram — Visual Inspection Automation System
...
flowchart LR
    ...
    subgraph SystemBoundary["Visual Inspection Automation System"]
        UC01(["Execute Visual Inspection Automation Line Operation"])
        UC02(["View Visual Inspection Automation Shop Floor Dashboard"])
        UC03(["Configure Line Parameters & Recipe"])
        UC04(["Process Visual Inspection Automation Quality Inspection"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Quality Assurance Engineer | Primary | Main user initiating visual inspection automation system operations. | UC01, UC02, UC03, UC11 |
| 2 | Quality Inspector | Primary | Manages line execution in visual inspection automation system. | UC04, UC05, UC06, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Execute Visual Inspection Automation Line Operation | Quality Assurance Engineer | PLC & SCADA Controller System | Initiate line operations and data capture in Visual Inspection Automation System. | High |
| 2 | UC02 | View Visual Inspection Automation Shop Floor Dashboard | Quality Assurance Engineer | None | Display real-time line metrics, machine statuses, and production output. | High |
...
| 4 | UC04 | Process Visual Inspection Automation Quality Inspection | Quality Inspector | Industrial Barcode & RFID Gateway | Perform dimensional, visual, or laboratory quality inspection tasks. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Execute Visual Inspection Automation Line Operation |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Process Visual Inspection Automation Quality Inspection |
