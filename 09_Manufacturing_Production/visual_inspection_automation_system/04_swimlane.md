# Swimlane Diagram — Visual Inspection Automation System
...
flowchart LR
    ...
    subgraph Lane2["Visual Inspection Automation System Control Core"]
...
| 2 | Visual Inspection Automation System Control Core | Validates inputs, controls machinery interfaces, computes OEE, records state. |
