# Action Tree — Boutique Hotel Management System

## Mermaid Code

```mermaid
graph TD
    Root["Boutique Hotel Management System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Boutique Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Boutique Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
