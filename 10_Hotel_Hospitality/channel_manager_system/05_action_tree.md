# Action Tree — Channel Manager System (Hotel)

## Mermaid Code

```mermaid
graph TD
    Root["Channel Manager System (Hotel)"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Distribution Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Distribution Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
