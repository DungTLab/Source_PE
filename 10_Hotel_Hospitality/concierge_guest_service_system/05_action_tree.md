# Action Tree — Concierge & Guest Service System

## Mermaid Code

```mermaid
graph TD
    Root["Concierge & Guest Service System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Concierge Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Concierge Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
