# Use Case Diagram — Corporate Travel & Rate Agreement System
...
flowchart LR
    ...
    subgraph SystemBoundary[" Corporate Travel & Rate Agreement System "]
        UC01(["Register Corporate Request"])
        UC02(["Process Corporate Transaction"])
        UC03(["Update Corporate Status"])
        UC04(["Approve Corporate Request"])
        UC05(["Generate Corporate Report"])
        UC06(["Configure Corporate Settings"])
        UC07(["Send Service Notification"])
        UC08(["Search Corporate History"])
        UC09(["Synchronize PMS Data"])
        UC10(["Cancel Corporate Task"])
        UC11(["Audit Corporate Logs"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register Corporate Request | Operations Staff | Hotel Guest | Create new operational request in Corporate Travel & Rate Agreement System. | High |
| 2 | UC02 | Process Corporate Transaction | Operations Staff | Payment Gateway | Execute payment or billing charge for Corporate Travel & Rate Agreement System. | High |
| 3 | UC03 | Update Corporate Status | Operations Staff | PMS Central Database | Modify operational status and update PMS database. | High |
| 4 | UC04 | Approve Corporate Request | Department Manager | None | Review and approve high-value or special requests. | High |
| 5 | UC05 | Generate Corporate Report | Department Manager | Audit & Compliance System | Compile performance metrics and operational summaries. | High |
| 6 | UC06 | Configure Corporate Settings | System Administrator | None | Maintain system master data, roles, and rules. | Medium |
...
| 8 | UC08 | Search Corporate History | Operations Staff | None | Query historical logs and previous records. | Medium |
| 9 | UC09 | Synchronize PMS Data | PMS Central Database | None | Sync real-time guest and room data with central PMS. | High |
| 10 | UC10 | Cancel Corporate Task | Operations Staff | Hotel Guest | Cancel active request upon guest cancellation. | Low |
| 11 | UC11 | Audit Corporate Logs | Department Manager | Audit & Compliance System | Review user audit trails and security compliance. | Medium |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Register Corporate Request |
| **Actor(s)** | Primary: Operations Staff / Secondary: Hotel Guest |
| **Description** | Thực hiện tiếp nhận và tạo mới yêu cầu nghiệp vụ trong hệ thống Corporate Travel & Rate Agreement System. |
...
|-------|--------|
| **UC ID** | UC02 |
| **Use Case Name** | Process Corporate Transaction |
| **Actor(s)** | Primary: Operations Staff / Secondary: Payment Gateway |
| **Description** | Xử lý thanh toán hoặc ghi nợ tài khoản dịch vụ cho Corporate Travel & Rate Agreement System. |
...
|-------|--------|
| **UC ID** | UC03 |
| **Use Case Name** | Update Corporate Status |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Approve Corporate Request |
...
|-------|--------|
| **UC ID** | UC05 |
| **Use Case Name** | Generate Corporate Report |
