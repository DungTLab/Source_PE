# Action Tree — Corporate Travel & Rate Agreement System

## Mermaid Code

```mermaid
graph TD
    Root["Corporate Travel & Rate Agreement System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Corporate Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Corporate Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
