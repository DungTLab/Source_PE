# Action Tree — Event & Conference Room Booking System

## Mermaid Code

```mermaid
graph TD
    Root["Event & Conference Room Booking System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Events Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Events Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
