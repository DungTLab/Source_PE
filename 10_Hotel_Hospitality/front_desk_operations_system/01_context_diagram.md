# Context Diagram — Front Desk Operations System
...
flowchart LR
    ...
    System((" Front Desk Operations System "))
...
|---|-------|------------|---------------------|---------------------------|-----------------|
| 1 | Front Desk Agent | Primary | Operation requests, status updates, transaction entries | Task assignments, system validations, operational logs | Nhân viên vận hành chính của Front Desk Operations System |
| 2 | Duty Manager | Primary | Approval requests, strategy configs, policy updates | Performance reports, exception alerts, operational dashboards | Quản lý cấp cao giám sát hoạt động của Front Desk Operations System |
...
Hệ thống Front Desk Operations System chịu trách nhiệm xử lý toàn bộ quy trình nghiệp vụ chuyên sâu thuộc lĩnh vực Front Desk. Hệ thống quản lý dữ liệu đầu vào từ Front Desk Agent và Hotel Guest, đồng bộ hóa tài khoản và giao dịch với PMS Central Database, đồng thời ủy quyền xử lý thanh toán tài chính cho Payment Gateway và gửi thông báo qua Notification Service.
