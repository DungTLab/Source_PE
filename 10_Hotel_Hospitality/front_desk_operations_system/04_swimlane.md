# Swimlane Diagram — Front Desk Operations System
...
flowchart LR
    ...
    subgraph UserLane[" Hotel Guest "]
        U1["Submit Front Desk request"]
    end

    subgraph StaffLane[" Front Desk Agent "]
...
| 2 | Front Desk Agent | Tiếp nhận, thực hiện công việc và cập nhật kết quả |
