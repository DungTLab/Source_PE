# Action Tree — Front Desk Operations System

## Mermaid Code

```mermaid
graph TD
    Root["Front Desk Operations System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Front Desk Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Front Desk Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
