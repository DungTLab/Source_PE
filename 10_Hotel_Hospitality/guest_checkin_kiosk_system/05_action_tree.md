# Action Tree — Guest Check-in Kiosk System

## Mermaid Code

```mermaid
graph TD
    Root["Guest Check-in Kiosk System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Kiosk Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Kiosk Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
