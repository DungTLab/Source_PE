# Use Case Diagram — Guest Feedback & Review Management System
...
flowchart LR
    ...
    subgraph SystemBoundary[" Guest Feedback & Review Management System "]
        UC01(["Register Feedback Request"])
        UC02(["Process Feedback Transaction"])
        UC03(["Update Feedback Status"])
        UC04(["Approve Feedback Request"])
        UC05(["Generate Feedback Report"])
        UC06(["Configure Feedback Settings"])
        UC07(["Send Service Notification"])
        UC08(["Search Feedback History"])
        UC09(["Synchronize PMS Data"])
        UC10(["Cancel Feedback Task"])
        UC11(["Audit Feedback Logs"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register Feedback Request | Operations Staff | Hotel Guest | Create new operational request in Guest Feedback & Review Management System. | High |
| 2 | UC02 | Process Feedback Transaction | Operations Staff | Payment Gateway | Execute payment or billing charge for Guest Feedback & Review Management System. | High |
| 3 | UC03 | Update Feedback Status | Operations Staff | PMS Central Database | Modify operational status and update PMS database. | High |
| 4 | UC04 | Approve Feedback Request | Department Manager | None | Review and approve high-value or special requests. | High |
| 5 | UC05 | Generate Feedback Report | Department Manager | Audit & Compliance System | Compile performance metrics and operational summaries. | High |
| 6 | UC06 | Configure Feedback Settings | System Administrator | None | Maintain system master data, roles, and rules. | Medium |
...
| 8 | UC08 | Search Feedback History | Operations Staff | None | Query historical logs and previous records. | Medium |
| 9 | UC09 | Synchronize PMS Data | PMS Central Database | None | Sync real-time guest and room data with central PMS. | High |
| 10 | UC10 | Cancel Feedback Task | Operations Staff | Hotel Guest | Cancel active request upon guest cancellation. | Low |
| 11 | UC11 | Audit Feedback Logs | Department Manager | Audit & Compliance System | Review user audit trails and security compliance. | Medium |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Register Feedback Request |
| **Actor(s)** | Primary: Operations Staff / Secondary: Hotel Guest |
| **Description** | Thực hiện tiếp nhận và tạo mới yêu cầu nghiệp vụ trong hệ thống Guest Feedback & Review Management System. |
...
|-------|--------|
| **UC ID** | UC02 |
| **Use Case Name** | Process Feedback Transaction |
| **Actor(s)** | Primary: Operations Staff / Secondary: Payment Gateway |
| **Description** | Xử lý thanh toán hoặc ghi nợ tài khoản dịch vụ cho Guest Feedback & Review Management System. |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Approve Feedback Request |
...
|-------|--------|
| **UC ID** | UC05 |
| **Use Case Name** | Generate Feedback Report |
