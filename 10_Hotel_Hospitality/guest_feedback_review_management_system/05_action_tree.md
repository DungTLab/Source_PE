# Action Tree — Guest Feedback & Review Management System

## Mermaid Code

```mermaid
graph TD
    Root["Guest Feedback & Review Management System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Feedback Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Feedback Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
