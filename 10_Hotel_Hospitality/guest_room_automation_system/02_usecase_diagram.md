# Use Case Diagram — Guest Room Automation System
...
flowchart LR
    ...
    subgraph SystemBoundary[" Guest Room Automation System "]
        UC01(["Register IoT Automation Request"])
        UC02(["Process IoT Automation Transaction"])
        UC03(["Update IoT Automation Status"])
        UC04(["Approve IoT Automation Request"])
        UC05(["Generate IoT Automation Report"])
        UC06(["Configure IoT Automation Settings"])
        UC07(["Send Service Notification"])
        UC08(["Search IoT Automation History"])
        UC09(["Synchronize PMS Data"])
        UC10(["Cancel IoT Automation Task"])
        UC11(["Audit IoT Automation Logs"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register IoT Automation Request | Operations Staff | Hotel Guest | Create new operational request in Guest Room Automation System. | High |
| 2 | UC02 | Process IoT Automation Transaction | Operations Staff | Payment Gateway | Execute payment or billing charge for Guest Room Automation System. | High |
| 3 | UC03 | Update IoT Automation Status | Operations Staff | PMS Central Database | Modify operational status and update PMS database. | High |
| 4 | UC04 | Approve IoT Automation Request | Department Manager | None | Review and approve high-value or special requests. | High |
| 5 | UC05 | Generate IoT Automation Report | Department Manager | Audit & Compliance System | Compile performance metrics and operational summaries. | High |
| 6 | UC06 | Configure IoT Automation Settings | System Administrator | None | Maintain system master data, roles, and rules. | Medium |
...
| 8 | UC08 | Search IoT Automation History | Operations Staff | None | Query historical logs and previous records. | Medium |
| 9 | UC09 | Synchronize PMS Data | PMS Central Database | None | Sync real-time guest and room data with central PMS. | High |
| 10 | UC10 | Cancel IoT Automation Task | Operations Staff | Hotel Guest | Cancel active request upon guest cancellation. | Low |
| 11 | UC11 | Audit IoT Automation Logs | Department Manager | Audit & Compliance System | Review user audit trails and security compliance. | Medium |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Register IoT Automation Request |
| **Actor(s)** | Primary: Operations Staff / Secondary: Hotel Guest |
| **Description** | Thực hiện tiếp nhận và tạo mới yêu cầu nghiệp vụ trong hệ thống Guest Room Automation System. |
...
|-------|--------|
| **UC ID** | UC02 |
| **Use Case Name** | Process IoT Automation Transaction |
| **Actor(s)** | Primary: Operations Staff / Secondary: Payment Gateway |
| **Description** | Xử lý thanh toán hoặc ghi nợ tài khoản dịch vụ cho Guest Room Automation System. |
...
|-------|--------|
| **UC ID** | UC03 |
| **Use Case Name** | Update IoT Automation Status |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Approve IoT Automation Request |
...
|-------|--------|
| **UC ID** | UC05 |
| **Use Case Name** | Generate IoT Automation Report |
