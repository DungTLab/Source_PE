# Action Tree — Guest Room Automation System

## Mermaid Code

```mermaid
graph TD
    Root["Guest Room Automation System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create IoT Automation Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create IoT Automation Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
