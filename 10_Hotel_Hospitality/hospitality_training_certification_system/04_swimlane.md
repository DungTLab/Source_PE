# Swimlane Diagram — Hospitality Training & Certification System
...
flowchart LR
    ...
    subgraph UserLane[" Hotel Guest "]
        U1["Submit Certification request"]
    end

    subgraph StaffLane[" Operations Staff "]
...
| 2 | Operations Staff | Tiếp nhận, thực hiện công việc và cập nhật kết quả |
