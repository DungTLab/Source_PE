# Action Tree — Hospitality Training & Certification System

## Mermaid Code

```mermaid
graph TD
    Root["Hospitality Training & Certification System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Certification Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Certification Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
