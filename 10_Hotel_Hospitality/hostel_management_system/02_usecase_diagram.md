...
flowchart LR
    ...
    subgraph SystemBoundary[" Hostel Management System "]
        UC01(["Register Hostel Request"])
        UC02(["Process Hostel Transaction"])
        UC03(["Update Hostel Status"])
        UC04(["Approve Hostel Request"])
        UC05(["Generate Hostel Report"])
        UC06(["Configure Hostel Settings"])
        UC07(["Send Service Notification"])
        UC08(["Search Hostel History"])
        UC09(["Synchronize PMS Data"])
        UC10(["Cancel Hostel Task"])
        UC11(["Audit Hostel Logs"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register Hostel Request | Operations Staff | Hotel Guest | Create new operational request in Hostel Management System. | High |
| 2 | UC02 | Process Hostel Transaction | Operations Staff | Payment Gateway | Execute payment or billing charge for Hostel Management System. | High |
| 3 | UC03 | Update Hostel Status | Operations Staff | PMS Central Database | Modify operational status and update PMS database. | High |
| 4 | UC04 | Approve Hostel Request | Department Manager | None | Review and approve high-value or special requests. | High |
| 5 | UC05 | Generate Hostel Report | Department Manager | Audit & Compliance System | Compile performance metrics and operational summaries. | High |
| 6 | UC06 | Configure Hostel Settings | System Administrator | None | Maintain system master data, roles, and rules. | Medium |
...
| 8 | UC08 | Search Hostel History | Operations Staff | None | Query historical logs and previous records. | Medium |
| 9 | UC09 | Synchronize PMS Data | PMS Central Database | None | Sync real-time guest and room data with central PMS. | High |
| 10 | UC10 | Cancel Hostel Task | Operations Staff | Hotel Guest | Cancel active request upon guest cancellation. | Low |
| 11 | UC11 | Audit Hostel Logs | Department Manager | Audit & Compliance System | Review user audit trails and security compliance. | Medium |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Register Hostel Request |
| **Actor(s)** | Primary: Operations Staff / Secondary: Hotel Guest |
| **Description** | Thực hiện tiếp nhận và tạo mới yêu cầu nghiệp vụ trong hệ thống Hostel Management System. |
...
|-------|--------|
| **UC ID** | UC02 |
| **Use Case Name** | Process Hostel Transaction |
| **Actor(s)** | Primary: Operations Staff / Secondary: Payment Gateway |
| **Description** | Xử lý thanh toán hoặc ghi nợ tài khoản dịch vụ cho Hostel Management System. |
...
|-------|--------|
| **UC ID** | UC03 |
| **Use Case Name** | Update Hostel Status |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Approve Hostel Request |
...
|-------|--------|
| **UC ID** | UC05 |
| **Use Case Name** | Generate Hostel Report |
