# Action Tree — Hostel Management System

## Mermaid Code

```mermaid
graph TD
    Root["Hostel Management System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Hostel Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Hostel Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
