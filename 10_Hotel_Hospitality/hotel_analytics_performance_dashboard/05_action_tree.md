# Action Tree — Hotel Analytics & Performance Dashboard

## Mermaid Code

```mermaid
graph TD
    Root["Hotel Analytics & Performance Dashboard"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Analytics Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Analytics Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
