# Action Tree — Hotel CRM & Guest Loyalty System

## Mermaid Code

```mermaid
graph TD
    Root["Hotel CRM & Guest Loyalty System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create CRM Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create CRM Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
