# Swimlane Diagram — Hotel Dynamic Pricing System
...
flowchart LR
    ...
    subgraph UserLane[" Hotel Guest "]
        U1["Submit Dynamic Pricing request"]
    end

    subgraph StaffLane[" Pricing Analyst "]
...
| 2 | Pricing Analyst | Tiếp nhận, thực hiện công việc và cập nhật kết quả |
