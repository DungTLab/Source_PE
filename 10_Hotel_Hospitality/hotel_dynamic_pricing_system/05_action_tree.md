# Action Tree — Hotel Dynamic Pricing System

## Mermaid Code

```mermaid
graph TD
    Root["Hotel Dynamic Pricing System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Dynamic Pricing Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Dynamic Pricing Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
