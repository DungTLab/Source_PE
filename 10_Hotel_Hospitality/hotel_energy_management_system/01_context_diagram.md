# Context Diagram — Hotel Energy Management System
...
flowchart LR
    ...
    System((" Hotel Energy Management System "))
...
|---|-------|------------|---------------------|---------------------------|-----------------|
| 1 | Maintenance Engineer | Primary | Operation requests, status updates, transaction entries | Task assignments, system validations, operational logs | Nhân viên vận hành chính của Hotel Energy Management System |
| 2 | Chief Engineer | Primary | Approval requests, strategy configs, policy updates | Performance reports, exception alerts, operational dashboards | Quản lý cấp cao giám sát hoạt động của Hotel Energy Management System |
...
Hệ thống Hotel Energy Management System chịu trách nhiệm xử lý toàn bộ quy trình nghiệp vụ chuyên sâu thuộc lĩnh vực Energy. Hệ thống quản lý dữ liệu đầu vào từ Maintenance Engineer và Hotel Guest, đồng bộ hóa tài khoản và giao dịch với PMS Central Database, đồng thời ủy quyền xử lý thanh toán tài chính cho Payment Gateway và gửi thông báo qua Notification Service.
