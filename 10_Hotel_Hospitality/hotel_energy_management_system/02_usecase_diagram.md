# Use Case Diagram — Hotel Energy Management System
...
flowchart LR
    ...
    subgraph SystemBoundary[" Hotel Energy Management System "]
        UC01(["Register Energy Request"])
        UC02(["Process Energy Transaction"])
        UC03(["Update Energy Status"])
        UC04(["Approve Energy Request"])
        UC05(["Generate Energy Report"])
        UC06(["Configure Energy Settings"])
        UC07(["Send Service Notification"])
        UC08(["Search Energy History"])
        UC09(["Synchronize PMS Data"])
        UC10(["Cancel Energy Task"])
        UC11(["Audit Energy Logs"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register Energy Request | Maintenance Engineer | Hotel Guest | Create new operational request in Hotel Energy Management System. | High |
| 2 | UC02 | Process Energy Transaction | Maintenance Engineer | Payment Gateway | Execute payment or billing charge for Hotel Energy Management System. | High |
| 3 | UC03 | Update Energy Status | Maintenance Engineer | PMS Central Database | Modify operational status and update PMS database. | High |
| 4 | UC04 | Approve Energy Request | Chief Engineer | None | Review and approve high-value or special requests. | High |
| 5 | UC05 | Generate Energy Report | Chief Engineer | Audit & Compliance System | Compile performance metrics and operational summaries. | High |
| 6 | UC06 | Configure Energy Settings | System Administrator | None | Maintain system master data, roles, and rules. | Medium |
...
| 8 | UC08 | Search Energy History | Maintenance Engineer | None | Query historical logs and previous records. | Medium |
| 9 | UC09 | Synchronize PMS Data | PMS Central Database | None | Sync real-time guest and room data with central PMS. | High |
| 10 | UC10 | Cancel Energy Task | Maintenance Engineer | Hotel Guest | Cancel active request upon guest cancellation. | Low |
| 11 | UC11 | Audit Energy Logs | Chief Engineer | Audit & Compliance System | Review user audit trails and security compliance. | Medium |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Register Energy Request |
| **Actor(s)** | Primary: Maintenance Engineer / Secondary: Hotel Guest |
| **Description** | Thực hiện tiếp nhận và tạo mới yêu cầu nghiệp vụ trong hệ thống Hotel Energy Management System. |
...
|-------|--------|
| **UC ID** | UC02 |
| **Use Case Name** | Process Energy Transaction |
| **Actor(s)** | Primary: Maintenance Engineer / Secondary: Payment Gateway |
| **Description** | Xử lý thanh toán hoặc ghi nợ tài khoản dịch vụ cho Hotel Energy Management System. |
...
|-------|--------|
| **UC ID** | UC03 |
| **Use Case Name** | Update Energy Status |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Approve Energy Request |
...
|-------|--------|
| **UC ID** | UC05 |
| **Use Case Name** | Generate Energy Report |
