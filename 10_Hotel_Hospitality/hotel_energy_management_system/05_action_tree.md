# Action Tree — Hotel Energy Management System

## Mermaid Code

```mermaid
graph TD
    Root["Hotel Energy Management System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Energy Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Energy Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
