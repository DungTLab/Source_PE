# Use Case Diagram — Hotel Franchise Compliance System
...
flowchart LR
    ...
    subgraph SystemBoundary[" Hotel Franchise Compliance System "]
        UC01(["Register Franchise Request"])
        UC02(["Process Franchise Transaction"])
        UC03(["Update Franchise Status"])
        UC04(["Approve Franchise Request"])
        UC05(["Generate Franchise Report"])
        UC06(["Configure Franchise Settings"])
        UC07(["Send Service Notification"])
        UC08(["Search Franchise History"])
        UC09(["Synchronize PMS Data"])
        UC10(["Cancel Franchise Task"])
        UC11(["Audit Franchise Logs"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register Franchise Request | Operations Staff | Hotel Guest | Create new operational request in Hotel Franchise Compliance System. | High |
| 2 | UC02 | Process Franchise Transaction | Operations Staff | Payment Gateway | Execute payment or billing charge for Hotel Franchise Compliance System. | High |
| 3 | UC03 | Update Franchise Status | Operations Staff | PMS Central Database | Modify operational status and update PMS database. | High |
| 4 | UC04 | Approve Franchise Request | Department Manager | None | Review and approve high-value or special requests. | High |
| 5 | UC05 | Generate Franchise Report | Department Manager | Audit & Compliance System | Compile performance metrics and operational summaries. | High |
| 6 | UC06 | Configure Franchise Settings | System Administrator | None | Maintain system master data, roles, and rules. | Medium |
...
| 8 | UC08 | Search Franchise History | Operations Staff | None | Query historical logs and previous records. | Medium |
| 9 | UC09 | Synchronize PMS Data | PMS Central Database | None | Sync real-time guest and room data with central PMS. | High |
| 10 | UC10 | Cancel Franchise Task | Operations Staff | Hotel Guest | Cancel active request upon guest cancellation. | Low |
| 11 | UC11 | Audit Franchise Logs | Department Manager | Audit & Compliance System | Review user audit trails and security compliance. | Medium |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Register Franchise Request |
| **Actor(s)** | Primary: Operations Staff / Secondary: Hotel Guest |
| **Description** | Thực hiện tiếp nhận và tạo mới yêu cầu nghiệp vụ trong hệ thống Hotel Franchise Compliance System. |
...
|-------|--------|
| **UC ID** | UC02 |
| **Use Case Name** | Process Franchise Transaction |
| **Actor(s)** | Primary: Operations Staff / Secondary: Payment Gateway |
| **Description** | Xử lý thanh toán hoặc ghi nợ tài khoản dịch vụ cho Hotel Franchise Compliance System. |
...
|-------|--------|
| **UC ID** | UC03 |
| **Use Case Name** | Update Franchise Status |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Approve Franchise Request |
...
|-------|--------|
| **UC ID** | UC05 |
| **Use Case Name** | Generate Franchise Report |
