# Action Tree — Hotel Franchise Compliance System

## Mermaid Code

```mermaid
graph TD
    Root["Hotel Franchise Compliance System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Franchise Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Franchise Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
