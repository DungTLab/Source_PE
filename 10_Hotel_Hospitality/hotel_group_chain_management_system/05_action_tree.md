# Action Tree — Hotel Group & Chain Management System

## Mermaid Code

```mermaid
graph TD
    Root["Hotel Group & Chain Management System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Chain Management Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Chain Management Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
