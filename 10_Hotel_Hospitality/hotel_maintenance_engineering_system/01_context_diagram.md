# Context Diagram — Hotel Maintenance & Engineering System

## Mermaid Code

```mermaid
flowchart LR
    Actor1["Maintenance Engineer"]
    Actor2["Chief Engineer"]
    Actor3["Hotel Guest"]
    ...
    System((" Hotel Maintenance & Engineering System "))
...
|---|-------|------------|---------------------|---------------------------|-----------------|
| 1 | Maintenance Engineer | Primary | Operation requests, status updates, transaction entries | Task assignments, system validations, operational logs | Nhân viên vận hành chính của Hotel Maintenance & Engineering System |
| 2 | Chief Engineer | Primary | Approval requests, strategy configs, policy updates | Performance reports, exception alerts, operational dashboards | Quản lý cấp cao giám sát hoạt động của Hotel Maintenance & Engineering System |
...
Hệ thống Hotel Maintenance & Engineering System chịu trách nhiệm xử lý toàn bộ quy trình nghiệp vụ chuyên sâu thuộc lĩnh vực Engineering. Hệ thống quản lý dữ liệu đầu vào từ Maintenance Engineer và Hotel Guest, đồng bộ hóa tài khoản và giao dịch với PMS Central Database, đồng thời ủy quyền xử lý thanh toán tài chính cho Payment Gateway và gửi thông báo qua Notification Service.
