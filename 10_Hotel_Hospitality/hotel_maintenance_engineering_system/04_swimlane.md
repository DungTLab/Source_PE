# Swimlane Diagram — Hotel Maintenance & Engineering System
...
flowchart LR
    ...
    subgraph UserLane[" Hotel Guest "]
        U1["Submit Engineering request"]
    end

    subgraph StaffLane[" Maintenance Engineer "]
...
| 2 | Maintenance Engineer | Tiếp nhận, thực hiện công việc và cập nhật kết quả |
