# Action Tree — Hotel Maintenance & Engineering System

## Mermaid Code

```mermaid
graph TD
    Root["Hotel Maintenance & Engineering System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Engineering Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Engineering Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
