# Action Tree — Hotel Procurement & Inventory System

## Mermaid Code

```mermaid
graph TD
    Root["Hotel Procurement & Inventory System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Procurement Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Procurement Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
