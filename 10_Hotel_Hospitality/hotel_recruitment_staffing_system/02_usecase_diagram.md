# Use Case Diagram — Hotel Recruitment & Staffing System
...
flowchart LR
    ...
    subgraph SystemBoundary[" Hotel Recruitment & Staffing System "]
        UC01(["Register Recruitment Request"])
        UC02(["Process Recruitment Transaction"])
        UC03(["Update Recruitment Status"])
        UC04(["Approve Recruitment Request"])
        UC05(["Generate Recruitment Report"])
        UC06(["Configure Recruitment Settings"])
        UC07(["Send Service Notification"])
        UC08(["Search Recruitment History"])
        UC09(["Synchronize PMS Data"])
        UC10(["Cancel Recruitment Task"])
        UC11(["Audit Recruitment Logs"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register Recruitment Request | Operations Staff | Hotel Guest | Create new operational request in Hotel Recruitment & Staffing System. | High |
| 2 | UC02 | Process Recruitment Transaction | Operations Staff | Payment Gateway | Execute payment or billing charge for Hotel Recruitment & Staffing System. | High |
| 3 | UC03 | Update Recruitment Status | Operations Staff | PMS Central Database | Modify operational status and update PMS database. | High |
| 4 | UC04 | Approve Recruitment Request | Department Manager | None | Review and approve high-value or special requests. | High |
| 5 | UC05 | Generate Recruitment Report | Department Manager | Audit & Compliance System | Compile performance metrics and operational summaries. | High |
| 6 | UC06 | Configure Recruitment Settings | System Administrator | None | Maintain system master data, roles, and rules. | Medium |
...
| 8 | UC08 | Search Recruitment History | Operations Staff | None | Query historical logs and previous records. | Medium |
| 9 | UC09 | Synchronize PMS Data | PMS Central Database | None | Sync real-time guest and room data with central PMS. | High |
| 10 | UC10 | Cancel Recruitment Task | Operations Staff | Hotel Guest | Cancel active request upon guest cancellation. | Low |
| 11 | UC11 | Audit Recruitment Logs | Department Manager | Audit & Compliance System | Review user audit trails and security compliance. | Medium |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Register Recruitment Request |
| **Actor(s)** | Primary: Operations Staff / Secondary: Hotel Guest |
| **Description** | Thực hiện tiếp nhận và tạo mới yêu cầu nghiệp vụ trong hệ thống Hotel Recruitment & Staffing System. |
...
|-------|--------|
| **UC ID** | UC02 |
| **Use Case Name** | Process Recruitment Transaction |
| **Actor(s)** | Primary: Operations Staff / Secondary: Payment Gateway |
| **Description** | Xử lý thanh toán hoặc ghi nợ tài khoản dịch vụ cho Hotel Recruitment & Staffing System. |
...
|-------|--------|
| **UC ID** | UC03 |
| **Use Case Name** | Update Recruitment Status |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Approve Recruitment Request |
...
|-------|--------|
| **UC ID** | UC05 |
| **Use Case Name** | Generate Recruitment Report |
