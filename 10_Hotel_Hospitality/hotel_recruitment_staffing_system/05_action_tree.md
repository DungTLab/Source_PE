# Action Tree — Hotel Recruitment & Staffing System

## Mermaid Code

```mermaid
graph TD
    Root["Hotel Recruitment & Staffing System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Recruitment Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Recruitment Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
