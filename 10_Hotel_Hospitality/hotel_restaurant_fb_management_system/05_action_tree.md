# Action Tree — Hotel Restaurant & F&B Management System

## Mermaid Code

```mermaid
graph TD
    Root["Hotel Restaurant & F&B Management System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create F&B Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create F&B Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
