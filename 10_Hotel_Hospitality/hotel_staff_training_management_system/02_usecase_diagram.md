# Use Case Diagram — Hotel Staff Training Management System
...
flowchart LR
    ...
    subgraph SystemBoundary[" Hotel Staff Training Management System "]
        UC01(["Register HR & Training Request"])
        UC02(["Process HR & Training Transaction"])
        UC03(["Update HR & Training Status"])
        UC04(["Approve HR & Training Request"])
        UC05(["Generate HR & Training Report"])
        UC06(["Configure HR & Training Settings"])
        UC07(["Send Service Notification"])
        UC08(["Search HR & Training History"])
        UC09(["Synchronize PMS Data"])
        UC10(["Cancel HR & Training Task"])
        UC11(["Audit HR & Training Logs"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register HR & Training Request | Operations Staff | Hotel Guest | Create new operational request in Hotel Staff Training Management System. | High |
| 2 | UC02 | Process HR & Training Transaction | Operations Staff | Payment Gateway | Execute payment or billing charge for Hotel Staff Training Management System. | High |
| 3 | UC03 | Update HR & Training Status | Operations Staff | PMS Central Database | Modify operational status and update PMS database. | High |
| 4 | UC04 | Approve HR & Training Request | Department Manager | None | Review and approve high-value or special requests. | High |
| 5 | UC05 | Generate HR & Training Report | Department Manager | Audit & Compliance System | Compile performance metrics and operational summaries. | High |
| 6 | UC06 | Configure HR & Training Settings | System Administrator | None | Maintain system master data, roles, and rules. | Medium |
...
| 8 | UC08 | Search HR & Training History | Operations Staff | None | Query historical logs and previous records. | Medium |
| 9 | UC09 | Synchronize PMS Data | PMS Central Database | None | Sync real-time guest and room data with central PMS. | High |
| 10 | UC10 | Cancel HR & Training Task | Operations Staff | Hotel Guest | Cancel active request upon guest cancellation. | Low |
| 11 | UC11 | Audit HR & Training Logs | Department Manager | Audit & Compliance System | Review user audit trails and security compliance. | Medium |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Register HR & Training Request |
| **Actor(s)** | Primary: Operations Staff / Secondary: Hotel Guest |
| **Description** | Thực hiện tiếp nhận và tạo mới yêu cầu nghiệp vụ trong hệ thống Hotel Staff Training Management System. |
...
|-------|--------|
| **UC ID** | UC02 |
| **Use Case Name** | Process HR & Training Transaction |
| **Actor(s)** | Primary: Operations Staff / Secondary: Payment Gateway |
| **Description** | Xử lý thanh toán hoặc ghi nợ tài khoản dịch vụ cho Hotel Staff Training Management System. |
...
|-------|--------|
| **UC ID** | UC03 |
| **Use Case Name** | Update HR & Training Status |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Approve HR & Training Request |
...
|-------|--------|
| **UC ID** | UC05 |
| **Use Case Name** | Generate HR & Training Report |
