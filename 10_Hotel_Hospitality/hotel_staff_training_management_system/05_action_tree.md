# Action Tree — Hotel Staff Training Management System

## Mermaid Code

```mermaid
graph TD
    Root["Hotel Staff Training Management System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create HR & Training Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create HR & Training Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
