# Use Case Diagram — Hotel Sustainability Tracking System
...
flowchart LR
    ...
    subgraph SystemBoundary[" Hotel Sustainability Tracking System "]
        UC01(["Register ESG Request"])
        UC02(["Process ESG Transaction"])
        UC03(["Update ESG Status"])
        UC04(["Approve ESG Request"])
        UC05(["Generate ESG Report"])
        UC06(["Configure ESG Settings"])
        UC07(["Send Service Notification"])
        UC08(["Search ESG History"])
        UC09(["Synchronize PMS Data"])
        UC10(["Cancel ESG Task"])
        UC11(["Audit ESG Logs"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register ESG Request | Operations Staff | Hotel Guest | Create new operational request in Hotel Sustainability Tracking System. | High |
| 2 | UC02 | Process ESG Transaction | Operations Staff | Payment Gateway | Execute payment or billing charge for Hotel Sustainability Tracking System. | High |
| 3 | UC03 | Update ESG Status | Operations Staff | PMS Central Database | Modify operational status and update PMS database. | High |
| 4 | UC04 | Approve ESG Request | Department Manager | None | Review and approve high-value or special requests. | High |
| 5 | UC05 | Generate ESG Report | Department Manager | Audit & Compliance System | Compile performance metrics and operational summaries. | High |
| 6 | UC06 | Configure ESG Settings | System Administrator | None | Maintain system master data, roles, and rules. | Medium |
...
| 8 | UC08 | Search ESG History | Operations Staff | None | Query historical logs and previous records. | Medium |
| 9 | UC09 | Synchronize PMS Data | PMS Central Database | None | Sync real-time guest and room data with central PMS. | High |
| 10 | UC10 | Cancel ESG Task | Operations Staff | Hotel Guest | Cancel active request upon guest cancellation. | Low |
| 11 | UC11 | Audit ESG Logs | Department Manager | Audit & Compliance System | Review user audit trails and security compliance. | Medium |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Register ESG Request |
| **Actor(s)** | Primary: Operations Staff / Secondary: Hotel Guest |
| **Description** | Thực hiện tiếp nhận và tạo mới yêu cầu nghiệp vụ trong hệ thống Hotel Sustainability Tracking System. |
...
|-------|--------|
| **UC ID** | UC02 |
| **Use Case Name** | Process ESG Transaction |
| **Actor(s)** | Primary: Operations Staff / Secondary: Payment Gateway |
| **Description** | Xử lý thanh toán hoặc ghi nợ tài khoản dịch vụ cho Hotel Sustainability Tracking System. |
...
|-------|--------|
| **UC ID** | UC03 |
| **Use Case Name** | Update ESG Status |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Approve ESG Request |
...
|-------|--------|
| **UC ID** | UC05 |
| **Use Case Name** | Generate ESG Report |
