# Action Tree — Hotel Sustainability Tracking System

## Mermaid Code

```mermaid
graph TD
    Root["Hotel Sustainability Tracking System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create ESG Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create ESG Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
