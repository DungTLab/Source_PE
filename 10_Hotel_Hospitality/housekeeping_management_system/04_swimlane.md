# Swimlane Diagram — Housekeeping Management System
...
flowchart LR
    ...
    subgraph UserLane[" Hotel Guest "]
        U1["Submit Housekeeping request"]
    end

    subgraph StaffLane[" Housekeeper "]
...
| 2 | Housekeeper | Tiếp nhận, thực hiện công việc và cập nhật kết quả |
