# Action Tree — Housekeeping Management System

## Mermaid Code

```mermaid
graph TD
    Root["Housekeeping Management System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Housekeeping Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Housekeeping Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
