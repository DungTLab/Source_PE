# Action Tree — Key Card & Access Control System

## Mermaid Code

```mermaid
graph TD
    Root["Key Card & Access Control System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Access Control Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Access Control Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
