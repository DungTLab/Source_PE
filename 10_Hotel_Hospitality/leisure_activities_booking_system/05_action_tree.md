# Action Tree — Leisure & Activities Booking System

## Mermaid Code

```mermaid
graph TD
    Root["Leisure & Activities Booking System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Recreation Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Recreation Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
