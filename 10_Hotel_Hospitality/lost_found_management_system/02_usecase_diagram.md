# Use Case Diagram — Lost & Found Management System
...
flowchart LR
    ...
    subgraph SystemBoundary[" Lost & Found Management System "]
        UC01(["Register Lost & Found Request"])
        UC02(["Process Lost & Found Transaction"])
        UC03(["Update Lost & Found Status"])
        UC04(["Approve Lost & Found Request"])
        UC05(["Generate Lost & Found Report"])
        UC06(["Configure Lost & Found Settings"])
        UC07(["Send Service Notification"])
        UC08(["Search Lost & Found History"])
        UC09(["Synchronize PMS Data"])
        UC10(["Cancel Lost & Found Task"])
        UC11(["Audit Lost & Found Logs"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register Lost & Found Request | Operations Staff | Hotel Guest | Create new operational request in Lost & Found Management System. | High |
| 2 | UC02 | Process Lost & Found Transaction | Operations Staff | Payment Gateway | Execute payment or billing charge for Lost & Found Management System. | High |
| 3 | UC03 | Update Lost & Found Status | Operations Staff | PMS Central Database | Modify operational status and update PMS database. | High |
| 4 | UC04 | Approve Lost & Found Request | Department Manager | None | Review and approve high-value or special requests. | High |
| 5 | UC05 | Generate Lost & Found Report | Department Manager | Audit & Compliance System | Compile performance metrics and operational summaries. | High |
| 6 | UC06 | Configure Lost & Found Settings | System Administrator | None | Maintain system master data, roles, and rules. | Medium |
...
| 8 | UC08 | Search Lost & Found History | Operations Staff | None | Query historical logs and previous records. | Medium |
| 9 | UC09 | Synchronize PMS Data | PMS Central Database | None | Sync real-time guest and room data with central PMS. | High |
| 10 | UC10 | Cancel Lost & Found Task | Operations Staff | Hotel Guest | Cancel active request upon guest cancellation. | Low |
| 11 | UC11 | Audit Lost & Found Logs | Department Manager | Audit & Compliance System | Review user audit trails and security compliance. | Medium |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Register Lost & Found Request |
| **Actor(s)** | Primary: Operations Staff / Secondary: Hotel Guest |
| **Description** | Thực hiện tiếp nhận và tạo mới yêu cầu nghiệp vụ trong hệ thống Lost & Found Management System. |
...
|-------|--------|
| **UC ID** | UC02 |
| **Use Case Name** | Process Lost & Found Transaction |
| **Actor(s)** | Primary: Operations Staff / Secondary: Payment Gateway |
| **Description** | Xử lý thanh toán hoặc ghi nợ tài khoản dịch vụ cho Lost & Found Management System. |
...
|-------|--------|
| **UC ID** | UC03 |
| **Use Case Name** | Update Lost & Found Status |
...
|-------|--------|
| **UC ID** | UC04 |
| **Use Case Name** | Approve Lost & Found Request |
...
|-------|--------|
| **UC ID** | UC05 |
| **Use Case Name** | Generate Lost & Found Report |
