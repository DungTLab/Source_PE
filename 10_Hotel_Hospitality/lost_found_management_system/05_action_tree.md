# Action Tree — Lost & Found Management System

## Mermaid Code

```mermaid
graph TD
    Root["Lost & Found Management System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Lost & Found Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Lost & Found Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
