# Swimlane Diagram — Mini-Bar & In-Room Service Management System
...
flowchart LR
    ...
    subgraph UserLane[" Hotel Guest "]
        U1["Submit Room Service request"]
    end

    subgraph StaffLane[" Order Runner "]
...
| 2 | Order Runner | Tiếp nhận, thực hiện công việc và cập nhật kết quả |
