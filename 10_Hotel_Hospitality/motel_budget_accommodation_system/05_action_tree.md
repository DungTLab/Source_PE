# Action Tree — Motel & Budget Accommodation System

## Mermaid Code

```mermaid
graph TD
    Root["Motel & Budget Accommodation System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Budget Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Budget Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
