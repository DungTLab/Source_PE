# Action Tree — Night Audit System (Hotel)

## Mermaid Code

```mermaid
graph TD
    Root["Night Audit System (Hotel)"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Audit Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Audit Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
