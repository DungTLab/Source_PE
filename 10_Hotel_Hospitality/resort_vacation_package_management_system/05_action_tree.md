# Action Tree — Resort & Vacation Package Management System

## Mermaid Code

```mermaid
graph TD
    Root["Resort & Vacation Package Management System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Resort Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Resort Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
