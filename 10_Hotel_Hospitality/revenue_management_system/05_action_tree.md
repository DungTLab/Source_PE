# Action Tree — Revenue Management System (Hotel)

## Mermaid Code

```mermaid
graph TD
    Root["Revenue Management System (Hotel)"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Revenue Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Revenue Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
