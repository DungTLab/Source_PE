# Use Case Diagram — Room Service Order Tracking System
...
flowchart LR
    ...
    subgraph SystemBoundary[" Room Service Order Tracking System "]
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register Room Service Request | Order Runner | Hotel Guest | Create new operational request in Room Service Order Tracking System. | High |
| 2 | UC02 | Process Room Service Transaction | Order Runner | Payment Gateway | Execute payment or billing charge for Room Service Order Tracking System. | High |
...
| **Description** | Thực hiện tiếp nhận và tạo mới yêu cầu nghiệp vụ trong hệ thống Room Service Order Tracking System. |
...
| **Description** | Xử lý thanh toán hoặc ghi nợ tài khoản dịch vụ cho Room Service Order Tracking System. |
