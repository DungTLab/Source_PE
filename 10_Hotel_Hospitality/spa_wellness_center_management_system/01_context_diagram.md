# Context Diagram — Spa & Wellness Center Management System

## Mermaid Code

```mermaid
flowchart LR
    Actor1["Spa Therapist"]
    Actor2["Spa Manager"]
    Actor3["Hotel Guest"]
    ...
    System((" Spa & Wellness Center Management System "))
...
|---|-------|------------|---------------------|---------------------------|-----------------|
| 1 | Spa Therapist | Primary | Operation requests, status updates, transaction entries | Task assignments, system validations, operational logs | Nhân viên vận hành chính của Spa & Wellness Center Management System |
| 2 | Spa Manager | Primary | Approval requests, strategy configs, policy updates | Performance reports, exception alerts, operational dashboards | Quản lý cấp cao giám sát hoạt động của Spa & Wellness Center Management System |
...
Hệ thống Spa & Wellness Center Management System chịu trách nhiệm xử lý toàn bộ quy trình nghiệp vụ chuyên sâu thuộc lĩnh vực Wellness. Hệ thống quản lý dữ liệu đầu vào từ Spa Therapist và Hotel Guest, đồng bộ hóa tài khoản và giao dịch với PMS Central Database, đồng thời ủy quyền xử lý thanh toán tài chính cho Payment Gateway và gửi thông báo qua Notification Service.
