# Swimlane Diagram — Spa & Wellness Center Management System
...
flowchart LR
    ...
    subgraph UserLane[" Hotel Guest "]
        U1["Submit Wellness request"]
    end

    subgraph StaffLane[" Spa Therapist "]
...
| 2 | Spa Therapist | Tiếp nhận, thực hiện công việc và cập nhật kết quả |
