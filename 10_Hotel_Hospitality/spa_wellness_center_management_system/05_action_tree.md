# Action Tree — Spa & Wellness Center Management System

## Mermaid Code

```mermaid
graph TD
    Root["Spa & Wellness Center Management System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Wellness Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Wellness Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
