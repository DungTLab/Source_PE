# Action Tree — Swimming Pool & Facilities Booking System

## Mermaid Code

```mermaid
graph TD
    Root["Swimming Pool & Facilities Booking System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Facilities Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Facilities Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
