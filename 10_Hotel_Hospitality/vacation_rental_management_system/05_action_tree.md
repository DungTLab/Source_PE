# Action Tree — Vacation Rental Management System

## Mermaid Code

```mermaid
graph TD
    Root["Vacation Rental Management System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create Vacation Rental Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create Vacation Rental Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
