# Swimlane Diagram — VIP Guest Management System
...
flowchart LR
    ...
    subgraph UserLane[" Hotel Guest "]
        U1["Submit VIP request"]
    end

    subgraph StaffLane[" Personal Butler "]
...
| 2 | Personal Butler | Tiếp nhận, thực hiện công việc và cập nhật kết quả |
