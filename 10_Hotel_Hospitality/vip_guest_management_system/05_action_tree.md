# Action Tree — VIP Guest Management System

## Mermaid Code

```mermaid
graph TD
    Root["VIP Guest Management System"]

    Root --> M1["Request & Intake Management"]
    M1 --> A1_1["Create VIP Ticket"]
...
|---|--------|-------------|---------|
| 1 | Request & Intake Management | Tiếp nhận và quản lý yêu cầu đầu vào | Create VIP Ticket, Search Active Tickets, Assign Staff Member, Prioritize Requests |
