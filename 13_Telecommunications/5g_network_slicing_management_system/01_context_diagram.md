# Context Diagram — 5G Network Slicing Management System

## Mermaid Code

```mermaid
flowchart LR
    System(("5G Network Slicing Management System"))
...
The **5G Network Slicing Management System** handles core operational workflows including data ingestion, policy enforcement, transactional processing, and regulatory reporting within the telecommunications domain. Out of scope operations include direct physical hardware manufacturing and external banking ledger management.
