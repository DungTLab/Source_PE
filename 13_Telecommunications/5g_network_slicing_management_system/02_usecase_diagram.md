# Use Case Diagram — 5G Network Slicing Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["5G Network Slicing Management System"]
        UC01(["Register & Provision 5GNetworkSlicingManagementSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision 5GNetworkSlicingManagementSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in 5G Network Slicing Management System. | High |
