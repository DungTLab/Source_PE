...
```mermaid
erDiagram
    5GNETWORKSLICINGMANAGEMENTSYSTEM_ELEMENT {
        element_id PK
        element_name string
    ...
    5GNETWORKSLICINGMANAGEMENTSYSTEM_ELEMENT ||--o{ OPERATIONAL_SESSION : "handles"
    5GNETWORKSLICINGMANAGEMENTSYSTEM_ELEMENT ||--o{ FAULT_ALARM : "triggers"
    5GNETWORKSLICINGMANAGEMENTSYSTEM_ELEMENT ||--o{ MAINTENANCE_TICKET : "requires"
    5GNETWORKSLICINGMANAGEMENTSYSTEM_ELEMENT ||--o{ PERFORMANCE_METRIC : "emits"
    CONFIGURATION_POLICY ||--o{ 5GNETWORKSLICINGMANAGEMENTSYSTEM_ELEMENT : "governs"
