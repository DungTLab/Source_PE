# Use Case Diagram — Broadband Installation & Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Broadband Installation & Management System"]
        UC01(["Register & Provision BroadbandInstallationManagementSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision BroadbandInstallationManagementSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Broadband Installation & Management System. | High |
