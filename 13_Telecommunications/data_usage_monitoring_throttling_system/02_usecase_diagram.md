# Use Case Diagram — Data Usage Monitoring & Throttling System
...
flowchart LR
    ...
    subgraph SystemBoundary["Data Usage Monitoring & Throttling System"]
        UC01(["Register & Provision DataUsageMonitoringThrottlingSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision DataUsageMonitoringThrottlingSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Data Usage Monitoring & Throttling System. | High |
