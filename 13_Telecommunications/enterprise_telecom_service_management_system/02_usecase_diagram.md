# Use Case Diagram — Enterprise Telecom Service Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Enterprise Telecom Service Management System"]
        UC01(["Register & Provision EnterpriseTelecomServiceManagementSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision EnterpriseTelecomServiceManagementSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Enterprise Telecom Service Management System. | High |
