# Use Case Diagram — IoT Connectivity Management Platform
...
flowchart LR
    ...
    subgraph SystemBoundary["IoT Connectivity Management Platform"]
        UC01(["Register & Provision IoTConnectivityManagementPlatform"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision IoTConnectivityManagementPlatform | NetworkOperator | CoreNetworkGateway | Register and provision new elements in IoT Connectivity Management Platform. | High |
