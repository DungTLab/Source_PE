# Use Case Diagram — ISP Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["ISP Management System"]
        UC01(["Register & Provision ISPManagementSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision ISPManagementSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in ISP Management System. | High |
