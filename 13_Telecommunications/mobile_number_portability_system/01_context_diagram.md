# Context Diagram — Mobile Number Portability System

## Mermaid Code

```mermaid
flowchart LR
    System(("Mobile Number Portability System"))
...
The **Mobile Number Portability System** handles core operational workflows including data ingestion, policy enforcement, transactional processing, and regulatory reporting within the telecommunications domain. Out of scope operations include direct physical hardware manufacturing and external banking ledger management.
