# Use Case Diagram — Mobile Number Portability System
...
flowchart LR
    ...
    subgraph SystemBoundary["Mobile Number Portability System"]
        UC01(["Register & Provision MobileNumberPortabilitySystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision MobileNumberPortabilitySystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Mobile Number Portability System. | High |
