# Use Case Diagram — MVNO Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["MVNO Management System"]
        UC01(["Register & Provision MVNOManagementSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision MVNOManagementSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in MVNO Management System. | High |
