# Use Case Diagram — Network Operations Center (NOC) System
...
flowchart LR
    ...
    subgraph SystemBoundary["Network Operations Center (NOC) System"]
        UC01(["Register & Provision NetworkOperationsCenterNOCSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision NetworkOperationsCenterNOCSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Network Operations Center (NOC) System. | High |
