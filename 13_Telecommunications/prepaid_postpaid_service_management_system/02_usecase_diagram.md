# Use Case Diagram — Prepaid & Postpaid Service Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Prepaid & Postpaid Service Management System"]
        UC01(["Register & Provision PrepaidPostpaidServiceManagementSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision PrepaidPostpaidServiceManagementSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Prepaid & Postpaid Service Management System. | High |
