# Use Case Diagram — Roaming Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Roaming Management System"]
        UC01(["Register & Provision RoamingManagementSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision RoamingManagementSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Roaming Management System. | High |
