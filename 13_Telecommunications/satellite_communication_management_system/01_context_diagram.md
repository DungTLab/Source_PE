# Context Diagram — Satellite Communication Management System

## Mermaid Code

```mermaid
flowchart LR
    System(("Satellite Communication Management System"))
...
The **Satellite Communication Management System** handles core operational workflows including data ingestion, policy enforcement, transactional processing, and regulatory reporting within the telecommunications domain. Out of scope operations include direct physical hardware manufacturing and external banking ledger management.
