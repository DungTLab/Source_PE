# Use Case Diagram — Satellite Communication Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Satellite Communication Management System"]
        UC01(["Register & Provision SatelliteCommunicationManagementSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision SatelliteCommunicationManagementSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Satellite Communication Management System. | High |
