# Use Case Diagram — Service Provisioning System
...
flowchart LR
    ...
    subgraph SystemBoundary["Service Provisioning System"]
        UC01(["Register & Provision ServiceProvisioningSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision ServiceProvisioningSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Service Provisioning System. | High |
