# Use Case Diagram — SIM Card Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["SIM Card Management System"]
        UC01(["Register & Provision SIMCardManagementSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision SIMCardManagementSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in SIM Card Management System. | High |
