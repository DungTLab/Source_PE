# Use Case Diagram — Spectrum Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Spectrum Management System"]
        UC01(["Register & Provision SpectrumManagementSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision SpectrumManagementSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Spectrum Management System. | High |
