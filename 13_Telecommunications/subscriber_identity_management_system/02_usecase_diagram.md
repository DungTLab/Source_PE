# Use Case Diagram — Subscriber Identity Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Subscriber Identity Management System"]
        UC01(["Register & Provision SubscriberIdentityManagementSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision SubscriberIdentityManagementSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Subscriber Identity Management System. | High |
