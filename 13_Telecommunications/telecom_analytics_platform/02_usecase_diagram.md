# Use Case Diagram — Telecom Analytics Platform
...
flowchart LR
    ...
    subgraph SystemBoundary["Telecom Analytics Platform"]
        UC01(["Register & Provision TelecomAnalyticsPlatform"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision TelecomAnalyticsPlatform | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Telecom Analytics Platform. | High |
