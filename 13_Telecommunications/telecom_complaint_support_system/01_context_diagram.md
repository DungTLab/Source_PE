# Context Diagram — Telecom Complaint & Support System

## Mermaid Code

```mermaid
flowchart LR
    System(("Telecom Complaint & Support System"))
...
The **Telecom Complaint & Support System** handles core operational workflows including data ingestion, policy enforcement, transactional processing, and regulatory reporting within the telecommunications domain. Out of scope operations include direct physical hardware manufacturing and external banking ledger management.
