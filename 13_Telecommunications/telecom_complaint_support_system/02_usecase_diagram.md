# Use Case Diagram — Telecom Complaint & Support System
...
flowchart LR
    ...
    subgraph SystemBoundary["Telecom Complaint & Support System"]
        UC01(["Register & Provision TelecomComplaintSupportSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision TelecomComplaintSupportSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Telecom Complaint & Support System. | High |
