# Use Case Diagram — Telecom CRM System
...
flowchart LR
    ...
    subgraph SystemBoundary["Telecom CRM System"]
        UC01(["Register & Provision TelecomCRMSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision TelecomCRMSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Telecom CRM System. | High |
