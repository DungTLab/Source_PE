# Context Diagram — Telecom Customer Churn Prediction System

## Mermaid Code

```mermaid
flowchart LR
    System(("Telecom Customer Churn Prediction System"))
...
The **Telecom Customer Churn Prediction System** handles core operational workflows including data ingestion, policy enforcement, transactional processing, and regulatory reporting within the telecommunications domain. Out of scope operations include direct physical hardware manufacturing and external banking ledger management.
