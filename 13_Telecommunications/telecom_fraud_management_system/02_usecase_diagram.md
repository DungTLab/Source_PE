# Use Case Diagram — Telecom Fraud Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Telecom Fraud Management System"]
        UC01(["Register & Provision TelecomFraudManagementSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision TelecomFraudManagementSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Telecom Fraud Management System. | High |
