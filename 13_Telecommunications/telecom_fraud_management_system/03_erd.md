# Conceptual ERD — Telecom Fraud Management System

## Mermaid Code

```mermaid
erDiagram
    TELECOMFRAUDMANAGEMENTSYSTEM_ELEMENT {
        element_id PK
        element_name string
    ...
    TELECOMFRAUDMANAGEMENTSYSTEM_ELEMENT ||--o{ OPERATIONAL_SESSION : "handles"
    TELECOMFRAUDMANAGEMENTSYSTEM_ELEMENT ||--o{ FAULT_ALARM : "triggers"
    TELECOMFRAUDMANAGEMENTSYSTEM_ELEMENT ||--o{ MAINTENANCE_TICKET : "requires"
    TELECOMFRAUDMANAGEMENTSYSTEM_ELEMENT ||--o{ PERFORMANCE_METRIC : "emits"
    CONFIGURATION_POLICY ||--o{ TELECOMFRAUDMANAGEMENTSYSTEM_ELEMENT : "governs"
...
|---|-------------|-----------------|-------------|----------------|-------------------|
| 1 | TELECOMFRAUDMANAGEMENTSYSTEM_ELEMENT | Phần tử Hệ Thống Quản Lý Gian Lận Viễn Thông | Main operational unit in Telecom Fraud Management System | element_id PK, element_name string, serial_number string | handles, triggers, requires, emits, governs |
...
|---|-------------|-------------|-----------|-------------------|----------------------|
| 1 | TELECOMFRAUDMANAGEMENTSYSTEM_ELEMENT | one-to-many | OPERATIONAL_SESSION | handles | One element handles multiple operational sessions |
| 2 | TELECOMFRAUDMANAGEMENTSYSTEM_ELEMENT | one-to-many | FAULT_ALARM | triggers | One element triggers multiple fault alarms |
| 3 | TELECOMFRAUDMANAGEMENTSYSTEM_ELEMENT | one-to-many | MAINTENANCE_TICKET | requires | One element may require multiple maintenance tickets |
| 4 | TELECOMFRAUDMANAGEMENTSYSTEM_ELEMENT | one-to-many | PERFORMANCE_METRIC | emits | One element emits time-series performance metrics |
| 5 | CONFIGURATION_POLICY | one-to-many | TELECOMFRAUDMANAGEMENTSYSTEM_ELEMENT | governs | One policy governs multiple network elements |
