# Use Case Diagram — Telecom Network Inventory System
...
flowchart LR
    ...
    subgraph SystemBoundary["Telecom Network Inventory System"]
        UC01(["Register & Provision TelecomNetworkInventorySystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision TelecomNetworkInventorySystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Telecom Network Inventory System. | High |
