# Use Case Diagram — Telecom Order Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Telecom Order Management System"]
        UC01(["Register & Provision TelecomOrderManagementSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision TelecomOrderManagementSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Telecom Order Management System. | High |
