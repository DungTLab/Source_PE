# Use Case Diagram — Telecom Partner & Interconnect System
...
flowchart LR
    ...
    subgraph SystemBoundary["Telecom Partner & Interconnect System"]
        UC01(["Register & Provision TelecomPartnerInterconnectSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision TelecomPartnerInterconnectSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Telecom Partner & Interconnect System. | High |
