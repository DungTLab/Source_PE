# Use Case Diagram — Telecom Regulatory Compliance System
...
flowchart LR
    ...
    subgraph SystemBoundary["Telecom Regulatory Compliance System"]
        UC01(["Register & Provision TelecomRegulatoryComplianceSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision TelecomRegulatoryComplianceSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Telecom Regulatory Compliance System. | High |
