# Use Case Diagram — Telephone Exchange Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Telephone Exchange Management System"]
        UC01(["Register & Provision TelephoneExchangeManagementSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision TelephoneExchangeManagementSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Telephone Exchange Management System. | High |
