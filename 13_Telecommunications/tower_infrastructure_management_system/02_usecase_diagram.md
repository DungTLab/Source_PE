# Use Case Diagram — Tower & Infrastructure Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Tower & Infrastructure Management System"]
        UC01(["Register & Provision TowerInfrastructureManagementSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision TowerInfrastructureManagementSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Tower & Infrastructure Management System. | High |
