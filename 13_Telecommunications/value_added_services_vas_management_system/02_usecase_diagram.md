# Use Case Diagram — Value-Added Services (VAS) Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Value-Added Services (VAS) Management System"]
        UC01(["Register & Provision ValueAddedServicesVASManagementSystem"])
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Register & Provision ValueAddedServicesVASManagementSystem | NetworkOperator | CoreNetworkGateway | Register and provision new elements in Value-Added Services (VAS) Management System. | High |
