# Conceptual ERD — Cycling Event Management System
...
erDiagram
    ...
    CYCLING_EVENT_USER ||--o{ CYCLING_EVENT_EVENT : "contains"
    CYCLING_EVENT_USER ||--o{ TRANSACTION_LOG : "generates"
    CYCLING_EVENT_EVENT ||--o{ RESOURCE_ITEM : "allocates"
...
|---|-------------|-----------------|-------------|----------------|--------------------|
| 1 | CYCLING_EVENT_USER | Người dùng chính | Stores user profiles and login details for Cycling Event Management System | user_id PK, full_name string, email string | places REQUEST, receives NOTIFICATION |
| 2 | CYCLING_EVENT_EVENT | Sự kiện / Giải đấu | Tracks scheduled events, matches, or sessions in Cycling Event Management System | event_id PK, title string, event_date datetime | has many SESSION, manages RESOURCE |
...
|---|-------------|-------------|-----------|-------------------|----------------------|
| 1 | CYCLING_EVENT_USER | one-to-many | CYCLING_EVENT_EVENT | contains | Single entity parent relates to multiple child records |
| 2 | CYCLING_EVENT_USER | one-to-many | TRANSACTION_LOG | generates | Creates financial logs for processing |
| 3 | CYCLING_EVENT_EVENT | one-to-many | RESOURCE_ITEM | allocates | Assigns physical resources for events |
