# Conceptual ERD — Fantasy Sports Platform
...
erDiagram
    ...
    FANTASY_SPORTS_USER ||--o{ FANTASY_SPORTS_EVENT : "contains"
    FANTASY_SPORTS_USER ||--o{ TRANSACTION_LOG : "generates"
    FANTASY_SPORTS_EVENT ||--o{ RESOURCE_ITEM : "allocates"
...
|---|-------------|-----------------|-------------|----------------|--------------------|
| 1 | FANTASY_SPORTS_USER | Người dùng chính | Stores user profiles and login details for Fantasy Sports Platform | user_id PK, full_name string, email string | places REQUEST, receives NOTIFICATION |
| 2 | FANTASY_SPORTS_EVENT | Sự kiện / Giải đấu | Tracks scheduled events, matches, or sessions in Fantasy Sports Platform | event_id PK, title string, event_date datetime | has many SESSION, manages RESOURCE |
...
|---|-------------|-------------|-----------|-------------------|----------------------|
| 1 | FANTASY_SPORTS_USER | one-to-many | FANTASY_SPORTS_EVENT | contains | Single entity parent relates to multiple child records |
| 2 | FANTASY_SPORTS_USER | one-to-many | TRANSACTION_LOG | generates | Creates financial logs for processing |
| 3 | FANTASY_SPORTS_EVENT | one-to-many | RESOURCE_ITEM | allocates | Assigns physical resources for events |
