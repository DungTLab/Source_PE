# Conceptual ERD — Golf Course Management System
...
erDiagram
    ...
    GOLF_COURSE_USER ||--o{ GOLF_COURSE_EVENT : "contains"
    GOLF_COURSE_USER ||--o{ TRANSACTION_LOG : "generates"
    GOLF_COURSE_EVENT ||--o{ RESOURCE_ITEM : "allocates"
...
|---|-------------|-----------------|-------------|----------------|--------------------|
| 1 | GOLF_COURSE_USER | Người dùng chính | Stores user profiles and login details for Golf Course Management System | user_id PK, full_name string, email string | places REQUEST, receives NOTIFICATION |
| 2 | GOLF_COURSE_EVENT | Sự kiện / Giải đấu | Tracks scheduled events, matches, or sessions in Golf Course Management System | event_id PK, title string, event_date datetime | has many SESSION, manages RESOURCE |
...
|---|-------------|-------------|-----------|-------------------|----------------------|
| 1 | GOLF_COURSE_USER | one-to-many | GOLF_COURSE_EVENT | contains | Single entity parent relates to multiple child records |
| 2 | GOLF_COURSE_USER | one-to-many | TRANSACTION_LOG | generates | Creates financial logs for processing |
| 3 | GOLF_COURSE_EVENT | one-to-many | RESOURCE_ITEM | allocates | Assigns physical resources for events |
