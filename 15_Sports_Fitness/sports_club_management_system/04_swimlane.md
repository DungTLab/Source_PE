# Swimlane Diagram — Sports Club Management System
...
flowchart LR
    ...
    subgraph Lane3["Club Administrator"]
...
|------|-------|-------------|
| 1 | Club Member | Initiates process and inputs payload |
| 2 | System Core Engine | Validates parameters, evaluates decisions, executes logic |
| 3 | Club Administrator | Reviews final outcomes and grants supervisor authorization |
