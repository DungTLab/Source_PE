...
erDiagram
    ...
    SPORTS_EQUIPMENT_RENTAL_USER ||--o{ SPORTS_EQUIPMENT_RENTAL_EVENT : "contains"
    SPORTS_EQUIPMENT_RENTAL_USER ||--o{ TRANSACTION_LOG : "generates"
    SPORTS_EQUIPMENT_RENTAL_EVENT ||--o{ RESOURCE_ITEM : "allocates"
