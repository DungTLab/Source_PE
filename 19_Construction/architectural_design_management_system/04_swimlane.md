# Swimlane Diagram — Architectural Design Management System
...
|------|----------------|--------------|
| 1 | Site Engineer | Initiates requests and logs operational data into Architectural Design Management System. |
