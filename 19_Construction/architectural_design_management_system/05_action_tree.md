# Action Tree — Architectural Design Management System

## Mermaid Code

```mermaid
graph TD
    Root["Architectural Design Management System"]
    ...
    M2 --> A2_1["Log Drawing Submissions Data"]
    M2 --> A2_2["Record  Revision Tracking Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log Drawing Submissions Data, Record  Revision Tracking Details, Attach Media Evidence |
