# Action Tree — Building Code Compliance System

## Mermaid Code

```mermaid
graph TD
    Root["Building Code Compliance System"]
    ...
    M2 --> A2_1["Log Fire Safety Audits Data"]
    M2 --> A2_2["Record  Accessibility Rules Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log Fire Safety Audits Data, Record  Accessibility Rules Details, Attach Media Evidence |
