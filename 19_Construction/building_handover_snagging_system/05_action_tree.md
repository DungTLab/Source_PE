# Action Tree — Building Handover & Snagging System

## Mermaid Code

```mermaid
graph TD
    Root["Building Handover & Snagging System"]
    ...
    M2 --> A2_1["Log Punch List Creation Data"]
    M2 --> A2_2["Record  Defect Rectification Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log Punch List Creation Data, Record  Defect Rectification Details, Attach Media Evidence |
