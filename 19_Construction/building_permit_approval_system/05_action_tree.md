# Action Tree — Building Permit & Approval System

## Mermaid Code

```mermaid
graph TD
    Root["Building Permit & Approval System"]
    ...
    M2 --> A2_1["Log Permit Applications Data"]
    M2 --> A2_2["Record  Municipal Inspections Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log Permit Applications Data, Record  Municipal Inspections Details, Attach Media Evidence |
