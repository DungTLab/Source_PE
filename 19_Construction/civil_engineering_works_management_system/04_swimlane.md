# Swimlane Diagram — Civil Engineering Works Management System
...
|------|----------------|--------------|
| 1 | Site Engineer | Initiates requests and logs operational data into Civil Engineering Works Management System. |
