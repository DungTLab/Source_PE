# Action Tree — Civil Engineering Works Management System

## Mermaid Code

```mermaid
graph TD
    Root["Civil Engineering Works Management System"]
    ...
    M2 --> A2_1["Log Earthworks Tracking Data"]
    M2 --> A2_2["Record  Concrete Pour Logs Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log Earthworks Tracking Data, Record  Concrete Pour Logs Details, Attach Media Evidence |
