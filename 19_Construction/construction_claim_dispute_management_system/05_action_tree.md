# Action Tree — Construction Claim & Dispute Management System

## Mermaid Code

```mermaid
graph TD
    Root["Construction Claim & Dispute Management System"]
    ...
    M2 --> A2_1["Log Delay EOT Claims Data"]
    M2 --> A2_2["Record  Dispute Evidence Log Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log Delay EOT Claims Data, Record  Dispute Evidence Log Details, Attach Media Evidence |
