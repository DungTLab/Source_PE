# Action Tree — Construction Cost Estimation System

## Mermaid Code

```mermaid
graph TD
    Root["Construction Cost Estimation System"]
    ...
    M2 --> A2_1["Log QTO Extraction Data"]
    M2 --> A2_2["Record  Unit Rate Database Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log QTO Extraction Data, Record  Unit Rate Database Details, Attach Media Evidence |
