# Swimlane Diagram — Construction Equipment Rental System
...
|------|----------------|--------------|
| 1 | Site Engineer | Initiates requests and logs operational data into Construction Equipment Rental System. |
