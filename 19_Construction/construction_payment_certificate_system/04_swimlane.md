# Swimlane Diagram — Construction Payment Certificate System
...
|------|----------------|--------------|
| 1 | Site Engineer | Initiates requests and logs operational data into Construction Payment Certificate System. |
