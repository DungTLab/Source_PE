# Action Tree — Construction Payment Certificate System

## Mermaid Code

```mermaid
graph TD
    Root["Construction Payment Certificate System"]
    ...
    M2 --> A2_1["Log Interim Valuation Data"]
    M2 --> A2_2["Record  Retention Escrow Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log Interim Valuation Data, Record  Retention Escrow Details, Attach Media Evidence |
