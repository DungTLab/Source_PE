# Action Tree — Construction Procurement System

## Mermaid Code

```mermaid
graph TD
    Root["Construction Procurement System"]
    ...
    M2 --> A2_1["Log RFQs Data"]
    M2 --> A2_2["Record  Tender Evaluation Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log RFQs Data, Record  Tender Evaluation Details, Attach Media Evidence |
