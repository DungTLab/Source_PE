# Swimlane Diagram — Construction Progress Tracking System
...
|------|----------------|--------------|
| 1 | Site Engineer | Initiates requests and logs operational data into Construction Progress Tracking System. |
