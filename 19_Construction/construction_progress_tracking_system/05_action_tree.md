# Action Tree — Construction Progress Tracking System

## Mermaid Code

```mermaid
graph TD
    Root["Construction Progress Tracking System"]
    ...
    M2 --> A2_1["Log Daily Site Logs Data"]
    M2 --> A2_2["Record  Earned Value Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log Daily Site Logs Data, Record  Earned Value Details, Attach Media Evidence |
