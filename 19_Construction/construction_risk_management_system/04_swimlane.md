# Swimlane Diagram — Construction Risk Management System
...
|------|----------------|--------------|
| 1 | Site Engineer | Initiates requests and logs operational data into Construction Risk Management System. |
