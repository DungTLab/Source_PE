# Action Tree — Construction Risk Management System

## Mermaid Code

```mermaid
graph TD
    Root["Construction Risk Management System"]
    ...
    M2 --> A2_1["Log Risk Identification Data"]
    M2 --> A2_2["Record  Probability Impact Matrix Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log Risk Identification Data, Record  Probability Impact Matrix Details, Attach Media Evidence |
