# Swimlane Diagram — Construction Workforce Management System
...
|------|----------------|--------------|
| 1 | Site Engineer | Initiates requests and logs operational data into Construction Workforce Management System. |
