# Action Tree — Construction Workforce Management System

## Mermaid Code

```mermaid
graph TD
    Root["Construction Workforce Management System"]
    ...
    M2 --> A2_1["Log Biometric Attendance Data"]
    M2 --> A2_2["Record  Trade Licenses Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log Biometric Attendance Data, Record  Trade Licenses Details, Attach Media Evidence |
