# Action Tree — Demolition Project Management System

## Mermaid Code

```mermaid
graph TD
    Root["Demolition Project Management System"]
    ...
    M2 --> A2_1["Log Hazmat Audit Data"]
    M2 --> A2_2["Record  Blast/Demolition Plan Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log Hazmat Audit Data, Record  Blast/Demolition Plan Details, Attach Media Evidence |
