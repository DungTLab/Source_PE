# Swimlane Diagram — Environmental Monitoring System (Construction)
...
|------|----------------|--------------|
| 1 | Site Engineer | Initiates requests and logs operational data into Environmental Monitoring System (Construction). |
