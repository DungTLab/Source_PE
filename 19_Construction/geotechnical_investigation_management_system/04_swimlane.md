# Swimlane Diagram — Geotechnical Investigation Management System
...
|------|----------------|--------------|
| 1 | Site Engineer | Initiates requests and logs operational data into Geotechnical Investigation Management System. |
