# Action Tree — Geotechnical Investigation Management System

## Mermaid Code

```mermaid
graph TD
    Root["Geotechnical Investigation Management System"]
    ...
    M2 --> A2_1["Log Borehole Soil Logs Data"]
    M2 --> A2_2["Record  Core Sampling Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log Borehole Soil Logs Data, Record  Core Sampling Details, Attach Media Evidence |
