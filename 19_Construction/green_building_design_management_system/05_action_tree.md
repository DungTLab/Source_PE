# Action Tree — Green Building Design Management System

## Mermaid Code

```mermaid
graph TD
    Root["Green Building Design Management System"]
    ...
    M2 --> A2_1["Log LEED/LOTUS Rating Data"]
    M2 --> A2_2["Record  Energy Efficiency Simulation Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log LEED/LOTUS Rating Data, Record  Energy Efficiency Simulation Details, Attach Media Evidence |
