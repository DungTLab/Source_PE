# Action Tree — Infrastructure Asset Management System

## Mermaid Code

```mermaid
graph TD
    Root["Infrastructure Asset Management System"]
    ...
    M2 --> A2_1["Log Asset Registry Data"]
    M2 --> A2_2["Record  Condition Assessment Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log Asset Registry Data, Record  Condition Assessment Details, Attach Media Evidence |
