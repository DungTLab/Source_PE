# Action Tree — Land Survey & Mapping System

## Mermaid Code

```mermaid
graph TD
    Root["Land Survey & Mapping System"]
    ...
    M2 --> A2_1["Log GPS Coordinates Data"]
    M2 --> A2_2["Record  Topographical Maps Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log GPS Coordinates Data, Record  Topographical Maps Details, Attach Media Evidence |
