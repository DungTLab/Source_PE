# Action Tree — MEP Management System

## Mermaid Code

```mermaid
graph TD
    Root["MEP Management System"]
    ...
    M2 --> A2_1["Log Ductwork/Piping Routing Data"]
    M2 --> A2_2["Record  Load Balancing Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log Ductwork/Piping Routing Data, Record  Load Balancing Details, Attach Media Evidence |
