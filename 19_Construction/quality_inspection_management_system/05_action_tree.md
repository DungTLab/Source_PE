# Action Tree — Quality Inspection Management System

## Mermaid Code

```mermaid
graph TD
    Root["Quality Inspection Management System"]
    ...
    M2 --> A2_1["Log QA/QC Checklists Data"]
    M2 --> A2_2["Record  Non-Conformance Reports (NCR) Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log QA/QC Checklists Data, Record  Non-Conformance Reports (NCR) Details, Attach Media Evidence |
