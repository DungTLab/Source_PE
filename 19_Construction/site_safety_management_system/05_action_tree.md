# Action Tree — Site Safety Management System

## Mermaid Code

```mermaid
graph TD
    Root["Site Safety Management System"]
    ...
    M2 --> A2_1["Log Safety Audits Data"]
    M2 --> A2_2["Record  Incident Logs Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log Safety Audits Data, Record  Incident Logs Details, Attach Media Evidence |
