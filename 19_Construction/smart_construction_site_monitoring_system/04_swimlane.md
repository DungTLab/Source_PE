# Swimlane Diagram — Smart Construction Site Monitoring System
...
|------|----------------|--------------|
| 1 | Site Engineer | Initiates requests and logs operational data into Smart Construction Site Monitoring System. |
