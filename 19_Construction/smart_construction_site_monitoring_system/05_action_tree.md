# Action Tree — Smart Construction Site Monitoring System

## Mermaid Code

```mermaid
graph TD
    Root["Smart Construction Site Monitoring System"]
    ...
    M2 --> A2_1["Log IoT Sensors Data"]
    M2 --> A2_2["Record  CCTV AI Feeds Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log IoT Sensors Data, Record  CCTV AI Feeds Details, Attach Media Evidence |
