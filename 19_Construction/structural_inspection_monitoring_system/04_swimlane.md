# Swimlane Diagram — Structural Inspection & Monitoring System
...
|------|----------------|--------------|
| 1 | Site Engineer | Initiates requests and logs operational data into Structural Inspection & Monitoring System. |
