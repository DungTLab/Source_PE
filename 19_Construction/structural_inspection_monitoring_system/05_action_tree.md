# Action Tree — Structural Inspection & Monitoring System

## Mermaid Code

```mermaid
graph TD
    Root["Structural Inspection & Monitoring System"]
    ...
    M2 --> A2_1["Log Structural Health Sensors Data"]
    M2 --> A2_2["Record  Stress Strain Gauges Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log Structural Health Sensors Data, Record  Stress Strain Gauges Details, Attach Media Evidence |
