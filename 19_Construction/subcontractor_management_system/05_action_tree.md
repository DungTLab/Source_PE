# Action Tree — Subcontractor Management System

## Mermaid Code

```mermaid
graph TD
    Root["Subcontractor Management System"]
    ...
    M2 --> A2_1["Log Vendor Prequalification Data"]
    M2 --> A2_2["Record  Bidding Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log Vendor Prequalification Data, Record  Bidding Details, Attach Media Evidence |
