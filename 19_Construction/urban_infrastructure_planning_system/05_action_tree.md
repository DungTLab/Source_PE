# Action Tree — Urban Infrastructure Planning System

## Mermaid Code

```mermaid
graph TD
    Root["Urban Infrastructure Planning System"]
    ...
    M2 --> A2_1["Log Zoning Models Data"]
    M2 --> A2_2["Record  Traffic Simulation Details"]
...
| 2 | Field Operational Logging Module | Handles core functions for Field Operational Logging Module | Log Zoning Models Data, Record  Traffic Simulation Details, Attach Media Evidence |
