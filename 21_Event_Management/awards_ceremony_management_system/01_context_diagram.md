# Context Diagram — Awards Ceremony Management System
...
flowchart LR
    ...
    System(("Awards Ceremony Management System"))

    Actor1 -->|"Awards Ceremony Mana parameters, strategy plan"| System
...
|---|-------|------------|---------------------|---------------------------|-------|
| 1 | Primary Director | Primary | Awards Ceremony Mana parameters, strategy plan | executive dashboard, audit metrics | Oversees master strategy, policy settings, and executive outcomes for Awards Ceremony Management System. |
| 2 | Operational Coordinator | Primary | schedule matrix, task allocations | execution logs, task completion alerts | Manages day-to-day scheduling, task delegation, and execution of award nomination submission, judging panel voting, finalist scoring, seating plan, red carpet entry check-in, trophy dispatch.. |
| 3 | Participant / End User | Primary | user profile, service request | digital access pass, confirmation notice | Registers, accesses services, and participates in Awards Ceremony Management System. |
