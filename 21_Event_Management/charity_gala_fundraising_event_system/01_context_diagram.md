# Context Diagram — Charity Gala & Fundraising Event System
...
flowchart LR
    ...
    System(("Charity Gala & Fundraising Event System"))

    Actor1 -->|"Charity Gala & Fundr parameters, strategy plan"| System
...
|---|-------|------------|---------------------|---------------------------|-------|
| 1 | Primary Director | Primary | Charity Gala & Fundr parameters, strategy plan | executive dashboard, audit metrics | Oversees master strategy, policy settings, and executive outcomes for Charity Gala & Fundraising Event System. |
| 2 | Operational Coordinator | Primary | schedule matrix, task allocations | execution logs, task completion alerts | Manages day-to-day scheduling, task delegation, and execution of charity gala ticketing, live auction management, donor pledge tracking, tax receipt issuance, donor hall seating, fundraising leaderboard.. |
| 3 | Participant / End User | Primary | user profile, service request | digital access pass, confirmation notice | Registers, accesses services, and participates in Charity Gala & Fundraising Event System. |
