# Use Case Diagram — Charity Gala & Fundraising Event System
...
flowchart LR
    ...
    subgraph SystemBoundary["Charity Gala & Fundraising Event System"]
        UC01(["Initialize Charity Gala & Fun Master Plan"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Primary Director | Primary | Oversees master strategy, policy settings, and executive outcomes for Charity Gala & Fundraising Event System. | UC01, UC02, UC06, UC10, UC11, UC14 |
| 2 | Operational Coordinator | Primary | Manages day-to-day scheduling, task delegation, and execution of charity gala ticketing, live auction management, donor pledge tracking, tax receipt issuance, donor hall seating, fundraising leaderboard.. | UC01, UC03, UC07, UC09, UC13 |
| 3 | Participant / End User | Primary | Registers, accesses services, and participates in Charity Gala & Fundraising Event System. | UC02, UC03, UC04, UC08, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Initialize Charity Gala & Fun Master Plan | Primary Director | Operational Coordinator | Set up system scope, target dates, venue parameters, and master rules. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Initialize Charity Gala & Fun Master Plan |
