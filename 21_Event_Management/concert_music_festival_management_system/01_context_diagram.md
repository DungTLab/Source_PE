# Context Diagram — Concert & Music Festival Management System
...
flowchart LR
    ...
    System(("Concert & Music Festival Management System"))

    Actor1 -->|"Concert & Music Fest parameters, strategy plan"| System
...
|---|-------|------------|---------------------|---------------------------|-------|
| 1 | Primary Director | Primary | Concert & Music Fest parameters, strategy plan | executive dashboard, audit metrics | Oversees master strategy, policy settings, and executive outcomes for Concert & Music Festival Management System. |
| 2 | Operational Coordinator | Primary | schedule matrix, task allocations | execution logs, task completion alerts | Manages day-to-day scheduling, task delegation, and execution of concert staging, artist lineup management, sound check logistics, wristband RFID check-in, crowd control, ticket scanning.. |
| 3 | Participant / End User | Primary | user profile, service request | digital access pass, confirmation notice | Registers, accesses services, and participates in Concert & Music Festival Management System. |
