# Use Case Diagram — Concert & Music Festival Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Concert & Music Festival Management System"]
        UC01(["Initialize Concert & Music Fe Master Plan"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Primary Director | Primary | Oversees master strategy, policy settings, and executive outcomes for Concert & Music Festival Management System. | UC01, UC02, UC06, UC10, UC11, UC14 |
| 2 | Operational Coordinator | Primary | Manages day-to-day scheduling, task delegation, and execution of concert staging, artist lineup management, sound check logistics, wristband RFID check-in, crowd control, ticket scanning.. | UC01, UC03, UC07, UC09, UC13 |
| 3 | Participant / End User | Primary | Registers, accesses services, and participates in Concert & Music Festival Management System. | UC02, UC03, UC04, UC08, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Initialize Concert & Music Fe Master Plan | Primary Director | Operational Coordinator | Set up system scope, target dates, venue parameters, and master rules. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Initialize Concert & Music Fe Master Plan |
