# Conceptual ERD — Concert & Music Festival Management System
...
|---|-------------|-----------------|-------------|----------------|-------------------|
| 1 | EVENT_MASTER | Bản ghi Sự kiện | Core master record representing Concert & Music Festival Management System. | event_id PK, event_code, title, category, status, start_date, end_date, total_budget, created_at | contains sessions, has participants |
