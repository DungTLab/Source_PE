# Context Diagram — Conference & Summit Management System
...
flowchart LR
    ...
    System(("Conference & Summit Management System"))

    Actor1 -->|"Conference & Summit  parameters, strategy plan"| System
...
|---|-------|------------|---------------------|---------------------------|-------|
| 1 | Primary Director | Primary | Conference & Summit  parameters, strategy plan | executive dashboard, audit metrics | Oversees master strategy, policy settings, and executive outcomes for Conference & Summit Management System. |
| 2 | Operational Coordinator | Primary | schedule matrix, task allocations | execution logs, task completion alerts | Manages day-to-day scheduling, task delegation, and execution of conference summit, keynotes, track management, speaker sessions, abstract submission, badge printing, attendee networking.. |
| 3 | Participant / End User | Primary | user profile, service request | digital access pass, confirmation notice | Registers, accesses services, and participates in Conference & Summit Management System. |
