# Context Diagram — Event Analytics & Reporting System
...
flowchart LR
    ...
    System(("Event Analytics & Reporting System"))

    Actor1 -->|"Event Analytics & Re parameters, strategy plan"| System
...
|---|-------|------------|---------------------|---------------------------|-------|
| 1 | Primary Director | Primary | Event Analytics & Re parameters, strategy plan | executive dashboard, audit metrics | Oversees master strategy, policy settings, and executive outcomes for Event Analytics & Reporting System. |
| 2 | Operational Coordinator | Primary | schedule matrix, task allocations | execution logs, task completion alerts | Manages day-to-day scheduling, task delegation, and execution of attendee footfall heatmaps, session attendance tracking, revenue analytics, sponsor ROI reports, post-event survey synthesis.. |
| 3 | Participant / End User | Primary | user profile, service request | digital access pass, confirmation notice | Registers, accesses services, and participates in Event Analytics & Reporting System. |
