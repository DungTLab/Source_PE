# Context Diagram — Event Badge & Check-in System
...
flowchart LR
    ...
    System(("Event Badge & Check-in System"))

    Actor1 -->|"Event Badge & Check- parameters, strategy plan"| System
...
|---|-------|------------|---------------------|---------------------------|-------|
| 1 | Primary Director | Primary | Event Badge & Check- parameters, strategy plan | executive dashboard, audit metrics | Oversees master strategy, policy settings, and executive outcomes for Event Badge & Check-in System. |
| 2 | Operational Coordinator | Primary | schedule matrix, task allocations | execution logs, task completion alerts | Manages day-to-day scheduling, task delegation, and execution of on-site self-service kiosk check-in, thermal badge printing, facial recognition check-in, RFID wristband encoding, gate turnstiles.. |
| 3 | Participant / End User | Primary | user profile, service request | digital access pass, confirmation notice | Registers, accesses services, and participates in Event Badge & Check-in System. |
