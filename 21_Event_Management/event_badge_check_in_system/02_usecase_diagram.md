# Use Case Diagram — Event Badge & Check-in System
...
flowchart LR
    ...
    subgraph SystemBoundary["Event Badge & Check-in System"]
        UC01(["Initialize Event Badge & Chec Master Plan"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Primary Director | Primary | Oversees master strategy, policy settings, and executive outcomes for Event Badge & Check-in System. | UC01, UC02, UC06, UC10, UC11, UC14 |
| 2 | Operational Coordinator | Primary | Manages day-to-day scheduling, task delegation, and execution of on-site self-service kiosk check-in, thermal badge printing, facial recognition check-in, RFID wristband encoding, gate turnstiles.. | UC01, UC03, UC07, UC09, UC13 |
| 3 | Participant / End User | Primary | Registers, accesses services, and participates in Event Badge & Check-in System. | UC02, UC03, UC04, UC08, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Initialize Event Badge & Chec Master Plan | Primary Director | Operational Coordinator | Set up system scope, target dates, venue parameters, and master rules. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Initialize Event Badge & Chec Master Plan |
