# Context Diagram — Event Crew & Logistics System
...
flowchart LR
    ...
    System(("Event Crew & Logistics System"))

    Actor1 -->|"Event Crew & Logisti parameters, strategy plan"| System
...
|---|-------|------------|---------------------|---------------------------|-------|
| 1 | Primary Director | Primary | Event Crew & Logisti parameters, strategy plan | executive dashboard, audit metrics | Oversees master strategy, policy settings, and executive outcomes for Event Crew & Logistics System. |
| 2 | Operational Coordinator | Primary | schedule matrix, task allocations | execution logs, task completion alerts | Manages day-to-day scheduling, task delegation, and execution of crew shift assignment, walkie-talkie channel allocation, freight logistics tracking, stage load-in/load-out, meal voucher dispatch.. |
| 3 | Participant / End User | Primary | user profile, service request | digital access pass, confirmation notice | Registers, accesses services, and participates in Event Crew & Logistics System. |
