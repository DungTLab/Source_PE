# Context Diagram — Event Safety & Security Management System
...
flowchart LR
    ...
    System(("Event Safety & Security Management System"))

    Actor1 -->|"Event Safety & Secur parameters, strategy plan"| System
...
|---|-------|------------|---------------------|---------------------------|-------|
| 1 | Primary Director | Primary | Event Safety & Secur parameters, strategy plan | executive dashboard, audit metrics | Oversees master strategy, policy settings, and executive outcomes for Event Safety & Security Management System. |
| 2 | Operational Coordinator | Primary | schedule matrix, task allocations | execution logs, task completion alerts | Manages day-to-day scheduling, task delegation, and execution of incident reporting, security guard post assignment, medical tent logging, evacuation plan broadcasting, lost and found registry.. |
| 3 | Participant / End User | Primary | user profile, service request | digital access pass, confirmation notice | Registers, accesses services, and participates in Event Safety & Security Management System. |
