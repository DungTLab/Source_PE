# Swimlane Diagram — Event Ticketing & Registration System
...
flowchart LR
    ...
    subgraph Lane4["Box Office Agent"]
...
|------|----------------|--------------------------|
| 1 | Event Attendee | Initiates process requests, configures parameters, and reviews final results. |
| 2 | System Core Engine | Validates business constraints, executes core logic, and produces output artifacts. |
| 3 | Payment Gateway | Performs physical/service interactions and confirms status updates. |
| 4 | Box Office Agent | Audits compliance, approves financial transactions, and locks completed records. |
