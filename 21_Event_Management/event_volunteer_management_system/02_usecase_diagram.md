# Use Case Diagram — Event Volunteer Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Event Volunteer Management System"]
        UC01(["Initialize Event Volunteer Ma Master Plan"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Primary Director | Primary | Oversees master strategy, policy settings, and executive outcomes for Event Volunteer Management System. | UC01, UC02, UC06, UC10, UC11, UC14 |
| 2 | Operational Coordinator | Primary | Manages day-to-day scheduling, task delegation, and execution of volunteer recruitment, shift scheduling, zone assignment, check-in tracking, uniform distribution, volunteer certificate generation.. | UC01, UC03, UC07, UC09, UC13 |
| 3 | Participant / End User | Primary | Registers, accesses services, and participates in Event Volunteer Management System. | UC02, UC03, UC04, UC08, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Initialize Event Volunteer Ma Master Plan | Primary Director | Operational Coordinator | Set up system scope, target dates, venue parameters, and master rules. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Initialize Event Volunteer Ma Master Plan |
