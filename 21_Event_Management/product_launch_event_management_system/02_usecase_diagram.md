# Use Case Diagram — Product Launch Event Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Product Launch Event Management System"]
        UC01(["Initialize Product Launch Eve Master Plan"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Primary Director | Primary | Oversees master strategy, policy settings, and executive outcomes for Product Launch Event Management System. | UC01, UC02, UC06, UC10, UC11, UC14 |
| 2 | Operational Coordinator | Primary | Manages day-to-day scheduling, task delegation, and execution of media press credentials, NDA sign-offs, launch demo staging, press kit distribution, livestream syndication, social hype tracking.. | UC01, UC03, UC07, UC09, UC13 |
| 3 | Participant / End User | Primary | Registers, accesses services, and participates in Product Launch Event Management System. | UC02, UC03, UC04, UC08, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Initialize Product Launch Eve Master Plan | Primary Director | Operational Coordinator | Set up system scope, target dates, venue parameters, and master rules. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Initialize Product Launch Eve Master Plan |
