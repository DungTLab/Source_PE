# Use Case Diagram — Public Festival & Holiday Event System
...
flowchart LR
    ...
    subgraph SystemBoundary["Public Festival & Holiday Event System"]
        UC01(["Initialize Public Festival &  Master Plan"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Primary Director | Primary | Oversees master strategy, policy settings, and executive outcomes for Public Festival & Holiday Event System. | UC01, UC02, UC06, UC10, UC11, UC14 |
| 2 | Operational Coordinator | Primary | Manages day-to-day scheduling, task delegation, and execution of public holiday festival management, street permit filing, crowd density monitoring, emergency squad dispatch, food vendor permits.. | UC01, UC03, UC07, UC09, UC13 |
| 3 | Participant / End User | Primary | Registers, accesses services, and participates in Public Festival & Holiday Event System. | UC02, UC03, UC04, UC08, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Initialize Public Festival &  Master Plan | Primary Director | Operational Coordinator | Set up system scope, target dates, venue parameters, and master rules. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Initialize Public Festival &  Master Plan |
