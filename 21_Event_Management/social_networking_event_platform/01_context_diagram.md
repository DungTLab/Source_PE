# Context Diagram — Social & Networking Event Platform
...
flowchart LR
    ...
    System(("Social & Networking Event Platform"))

    Actor1 -->|"Social & Networking  parameters, strategy plan"| System
...
|---|-------|------------|---------------------|---------------------------|-------|
| 1 | Primary Director | Primary | Social & Networking  parameters, strategy plan | executive dashboard, audit metrics | Oversees master strategy, policy settings, and executive outcomes for Social & Networking Event Platform. |
| 2 | Operational Coordinator | Primary | schedule matrix, task allocations | execution logs, task completion alerts | Manages day-to-day scheduling, task delegation, and execution of meetup creation, interest group matching, venue RSVP, drink ticket redemption, social feed, community host reviews.. |
| 3 | Participant / End User | Primary | user profile, service request | digital access pass, confirmation notice | Registers, accesses services, and participates in Social & Networking Event Platform. |
