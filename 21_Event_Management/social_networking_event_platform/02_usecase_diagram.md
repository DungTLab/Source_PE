# Use Case Diagram — Social & Networking Event Platform
...
flowchart LR
    ...
    subgraph SystemBoundary["Social & Networking Event Platform"]
        UC01(["Initialize Social & Networkin Master Plan"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Primary Director | Primary | Oversees master strategy, policy settings, and executive outcomes for Social & Networking Event Platform. | UC01, UC02, UC06, UC10, UC11, UC14 |
| 2 | Operational Coordinator | Primary | Manages day-to-day scheduling, task delegation, and execution of meetup creation, interest group matching, venue RSVP, drink ticket redemption, social feed, community host reviews.. | UC01, UC03, UC07, UC09, UC13 |
| 3 | Participant / End User | Primary | Registers, accesses services, and participates in Social & Networking Event Platform. | UC02, UC03, UC04, UC08, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Initialize Social & Networkin Master Plan | Primary Director | Operational Coordinator | Set up system scope, target dates, venue parameters, and master rules. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Initialize Social & Networkin Master Plan |
