# Use Case Diagram — Speaker & Agenda Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Speaker & Agenda Management System"]
        UC01(["Initialize Speaker & Agenda M Master Plan"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Primary Director | Primary | Oversees master strategy, policy settings, and executive outcomes for Speaker & Agenda Management System. | UC01, UC02, UC06, UC10, UC11, UC14 |
| 2 | Operational Coordinator | Primary | Manages day-to-day scheduling, task delegation, and execution of call for papers, abstract reviewing, speaker slide submission, session schedule matrix, bio directory, AV room equipment checks.. | UC01, UC03, UC07, UC09, UC13 |
| 3 | Participant / End User | Primary | Registers, accesses services, and participates in Speaker & Agenda Management System. | UC02, UC03, UC04, UC08, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Initialize Speaker & Agenda M Master Plan | Primary Director | Operational Coordinator | Set up system scope, target dates, venue parameters, and master rules. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Initialize Speaker & Agenda M Master Plan |
