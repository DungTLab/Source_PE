# Context Diagram — Sponsorship Management System
...
flowchart LR
    ...
    System(("Sponsorship Management System"))

    Actor1 -->|"Sponsorship Manageme parameters, strategy plan"| System
...
|---|-------|------------|---------------------|---------------------------|-------|
| 1 | Primary Director | Primary | Sponsorship Manageme parameters, strategy plan | executive dashboard, audit metrics | Oversees master strategy, policy settings, and executive outcomes for Sponsorship Management System. |
| 2 | Operational Coordinator | Primary | schedule matrix, task allocations | execution logs, task completion alerts | Manages day-to-day scheduling, task delegation, and execution of sponsor package configuration, brand placement tracking, contract signing, deliverable proof upload, ROI analytics, lead sharing.. |
| 3 | Participant / End User | Primary | user profile, service request | digital access pass, confirmation notice | Registers, accesses services, and participates in Sponsorship Management System. |
