# Context Diagram — Virtual & Hybrid Event Platform
...
flowchart LR
    ...
    System(("Virtual & Hybrid Event Platform"))

    Actor1 -->|"Virtual & Hybrid Eve parameters, strategy plan"| System
...
|---|-------|------------|---------------------|---------------------------|-------|
| 1 | Primary Director | Primary | Virtual & Hybrid Eve parameters, strategy plan | executive dashboard, audit metrics | Oversees master strategy, policy settings, and executive outcomes for Virtual & Hybrid Event Platform. |
| 2 | Operational Coordinator | Primary | schedule matrix, task allocations | execution logs, task completion alerts | Manages day-to-day scheduling, task delegation, and execution of virtual event streaming, hybrid attendee sync, interactive Q&A, live polling, virtual breakout rooms, sponsor booths.. |
| 3 | Participant / End User | Primary | user profile, service request | digital access pass, confirmation notice | Registers, accesses services, and participates in Virtual & Hybrid Event Platform. |
