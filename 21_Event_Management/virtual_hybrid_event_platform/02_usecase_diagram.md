# Use Case Diagram — Virtual & Hybrid Event Platform
...
flowchart LR
    ...
    subgraph SystemBoundary["Virtual & Hybrid Event Platform"]
        UC01(["Initialize Virtual & Hybrid E Master Plan"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Primary Director | Primary | Oversees master strategy, policy settings, and executive outcomes for Virtual & Hybrid Event Platform. | UC01, UC02, UC06, UC10, UC11, UC14 |
| 2 | Operational Coordinator | Primary | Manages day-to-day scheduling, task delegation, and execution of virtual event streaming, hybrid attendee sync, interactive Q&A, live polling, virtual breakout rooms, sponsor booths.. | UC01, UC03, UC07, UC09, UC13 |
| 3 | Participant / End User | Primary | Registers, accesses services, and participates in Virtual & Hybrid Event Platform. | UC02, UC03, UC04, UC08, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Initialize Virtual & Hybrid E Master Plan | Primary Director | Operational Coordinator | Set up system scope, target dates, venue parameters, and master rules. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Initialize Virtual & Hybrid E Master Plan |
