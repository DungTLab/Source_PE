# Conceptual ERD — Virtual & Hybrid Event Platform
...
|---|-------------|-----------------|-------------|----------------|-------------------|
| 1 | EVENT_MASTER | Bản ghi Sự kiện | Core master record representing Virtual & Hybrid Event Platform. | event_id PK, event_code, title, category, status, start_date, end_date, total_budget, created_at | contains sessions, has participants |
