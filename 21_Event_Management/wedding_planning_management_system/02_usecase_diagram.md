# Use Case Diagram — Wedding Planning Management System
...
flowchart LR
    ...
    subgraph SystemBoundary["Wedding Planning Management System"]
        UC01(["Initialize Wedding Planning M Master Plan"])
...
|---|-------|------------|------------------|-------------------|
| 1 | Primary Director | Primary | Oversees master strategy, policy settings, and executive outcomes for Wedding Planning Management System. | UC01, UC02, UC06, UC10, UC11, UC14 |
| 2 | Operational Coordinator | Primary | Manages day-to-day scheduling, task delegation, and execution of wedding coordination, bride/groom budget, seating arrangements, catering menu selection, vendor contracts, RSVP management.. | UC01, UC03, UC07, UC09, UC13 |
| 3 | Participant / End User | Primary | Registers, accesses services, and participates in Wedding Planning Management System. | UC02, UC03, UC04, UC08, UC13 |
...
|---|-------|---------------|---------------|-----------------|-------------|----------|
| 1 | UC01 | Initialize Wedding Planning M Master Plan | Primary Director | Operational Coordinator | Set up system scope, target dates, venue parameters, and master rules. | High |
...
|-------|--------|
| **UC ID** | UC01 |
| **Use Case Name** | Initialize Wedding Planning M Master Plan |
